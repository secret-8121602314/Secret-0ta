...
${A}`;if(n+w.length>Vt){const C=Ee.indexOf(d.id);if(C!==-1&&C<3){const F=`### ${d.title} (ID: ${d.id}) [SUMMARY]
${m.slice(0,500)}...`;return n+=F.length,F}return null}return n+=w.length,w}).filter(Boolean).join(`
...
**Tag Definitions:**
${Se}
`},ds=async(a,e,t,r,s,o,n,i,c)=>{const u=n?zt(n):"",f=i?`
**User Timezone:** ${i}
...
*Content loading...*`}}const ms=new tr,rr=`You are a correction validator for OTAKON, an AI gaming companion.
