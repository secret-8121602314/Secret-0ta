var dt=Object.defineProperty;var gt=(a,e,t)=>e in a?dt(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var b=(a,e,t)=>gt(a,typeof e!="symbol"?e+"":e,t);import{s as l}from"./auth-Dblf_9Mg.js";import{l as mt,v as ht}from"./gaming-services-EvPXMx7T.js";import{C as pt,n as ft,s as yt,S as $,U as St,T as Le,a as Z,j as K,c as ie,e as bt}from"./chat-services-CFUx6KF_.js";import{i as Tt,a as ce}from"./core-services-q7awoLVY.js";import{S as W,c as Et}from"./storage-services-CNz7Dq7v.js";class wt{constructor(){b(this,"toasts",[]);b(this,"listeners",new Set);b(this,"maxToasts",5)}subscribe(e){return this.listeners.add(e),e(this.toasts),()=>{this.listeners.delete(e)}}notify(){this.listeners.forEach(e=>e([...this.toasts]))}show(e,t="info",r={}){const s=`toast-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,o={id:s,message:e,type:t,duration:r.duration??this.getDefaultDuration(t),action:r.action,dismissible:r.dismissible??!0};return this.toasts.unshift(o),this.toasts.length>this.maxToasts&&(this.toasts=this.toasts.slice(0,this.maxToasts)),this.notify(),o.duration&&o.duration>0&&setTimeout(()=>this.dismiss(s),o.duration),s}success(e,t){return this.show(e,"success",{duration:3e3,...t})}error(e,t){return this.show(e,"error",{duration:7e3,dismissible:!0,...t})}warning(e,t){return this.show(e,"warning",{duration:5e3,...t})}info(e,t){return this.show(e,"info",{duration:4e3,...t})}dismiss(e){const t=this.toasts.findIndex(r=>r.id===e);t!==-1&&(this.toasts.splice(t,1),this.notify())}dismissAll(){this.toasts=[],this.notify()}getDefaultDuration(e){switch(e){case"success":return 3e3;case"error":return 7e3;case"warning":return 5e3;case"info":return 4e3;default:return 4e3}}loading(e){const t=this.show(e,"info",{duration:0,dismissible:!1});return()=>this.dismiss(t)}async promise(e,t){const r=this.loading(t.loading);try{const s=await e;r();const o=typeof t.success=="function"?t.success(s):t.success;return this.success(o),s}catch(s){r();const o=typeof t.error=="function"?t.error(s):t.error;throw this.error(o),s}}}const R=new wt;let se=!1;typeof window<"u"&&typeof document<"u"&&(document.addEventListener("visibilitychange",()=>{se=document.hidden}),window.addEventListener("blur",()=>{se=!0}),window.addEventListener("focus",()=>{document.hidden||(se=!1)}));const _t=async(a,e="Otagon AI")=>{if(!(!se&&!document.hidden)&&!(!("Notification"in window)||Notification.permission!=="granted"))try{const t=a.length>100?a.substring(0,97)+"...":a,r=new Notification(e,{body:t,icon:"/icon-192.png",badge:"/icon-192.png",tag:"otagon-ai-response",requireInteraction:!1,silent:!1});setTimeout(()=>r.close(),1e4),r.onclick=()=>{window.focus(),r.close()}}catch(t){console.error("Failed to show notification:",t)}},At=()=>se||document.hidden,Xr=Object.freeze(Object.defineProperty({__proto__:null,isScreenLockedOrHidden:At,showAINotification:_t,toastService:R},Symbol.toStringTag,{value:"Module"}));class le{static handle(e,t,r){this.errorCount++,!this.isErrorRateLimited()&&(console.error(`[${t}]`,{message:e.message,stack:e.stack,context:t,timestamp:new Date().toISOString(),errorCount:this.errorCount}),r&&this.showUserMessage(r),this.reportError(e,t))}static handleAuthError(e,t){const r=this.getAuthErrorMessage(t);this.handle(e,`AuthService:${t}`,r)}static handleWebSocketError(e,t){const r=this.getWebSocketErrorMessage(t);this.handle(e,`WebSocketService:${t}`,r)}static handleConversationError(e,t){const r=this.getConversationErrorMessage(t);this.handle(e,`ConversationService:${t}`,r)}static handleDatabaseError(e,t){const r=this.getDatabaseErrorMessage(t);this.handle(e,`DatabaseService:${t}`,r)}static isErrorRateLimited(){const e=Date.now();return this.recentErrors=this.recentErrors.filter(t=>e-t<this.errorWindow),this.recentErrors.push(e),this.recentErrors.length>this.maxErrorsPerMinute}static showUserMessage(e){}static reportError(e,t){console.warn("[Error Reporting] Would report error to monitoring service:",{error:e.message,context:t,timestamp:new Date().toISOString()})}static getAuthErrorMessage(e){return{signIn:"Failed to sign in. Please check your credentials and try again.",signOut:"Failed to sign out. Please try again.",loadUser:"Failed to load user data. Please refresh the page.",createUser:"Failed to create user account. Please try again.",refreshUser:"Failed to refresh user data. Please try again."}[e]||"An authentication error occurred. Please try again."}static getWebSocketErrorMessage(e){return{connect:"Failed to connect to server. Please check your internet connection.",send:"Failed to send message. Please try again.",disconnect:"Failed to disconnect. Please try again."}[e]||"A connection error occurred. Please try again."}static getConversationErrorMessage(e){return{create:"Failed to create conversation. Please try again.",load:"Failed to load conversations. Please refresh the page.",save:"Failed to save conversation. Please try again.",delete:"Failed to delete conversation. Please try again."}[e]||"A conversation error occurred. Please try again."}static getDatabaseErrorMessage(e){return{save:"Failed to save data. Please try again.",load:"Failed to load data. Please refresh the page.",update:"Failed to update data. Please try again.",delete:"Failed to delete data. Please try again."}[e]||"A database error occurred. Please try again."}static getStats(){return{totalErrors:this.errorCount,recentErrors:this.recentErrors.length,isRateLimited:this.isErrorRateLimited()}}static reset(){this.errorCount=0,this.recentErrors=[]}}b(le,"errorCount",0),b(le,"maxErrorsPerMinute",10),b(le,"errorWindow",60*1e3),b(le,"recentErrors",[]);const ee=a=>a,Y=class Y{constructor(){}static getInstance(){return Y.instance||(Y.instance=new Y),Y.instance}async getOnboardingStatus(e){try{const{data:t,error:r}=await l.rpc("get_user_onboarding_status",{p_user_id:e});if(r)return console.error("🎯 [OnboardingService] Error getting onboarding status:",r),null;if(!t||t.length===0)return null;const s=t[0];return console.log("🎯 [OnboardingService] Onboarding status (first element):",s),s}catch(t){return console.error("🎯 [OnboardingService] Error getting onboarding status:",t),null}}async updateOnboardingStatus(e,t,r={}){try{const{error:s}=await l.rpc("update_user_onboarding_status",{p_user_id:e,p_step:t,p_data:ee(r)});return s?(console.error("Error updating onboarding status:",s),!1):!0}catch(s){return console.error("Error updating onboarding status:",s),!1}}async getOnboardingProgress(e){try{const{data:t,error:r}=await l.from("onboarding_progress").select("*").eq("user_id",e).order("completed_at",{ascending:!0});return r?(console.error("Error getting onboarding progress:",r),[]):(t||[]).map(s=>({step:s.step,completed_at:s.created_at||"",data:typeof s.data=="object"&&s.data!==null&&!Array.isArray(s.data)?s.data:{}}))}catch(t){return console.error("Error getting onboarding progress:",t),[]}}async markSplashScreensSeen(e){return this.updateOnboardingStatus(e,"initial",{splash_screens_seen:!0,timestamp:new Date().toISOString()})}async markProfileSetupComplete(e,t){try{console.log("🔍 [DEBUG onboardingService] markProfileSetupComplete called for user:",e);const{error:r}=await l.from("users").update({has_profile_setup:!0,profile_data:ee(t),onboarding_completed:!0,app_state:ee({onboardingStatus:"complete",hasSeenSplashScreens:!0,hasSeenHowToUse:!0,hasSeenFeaturesConnected:!0,completedAt:new Date().toISOString()}),updated_at:new Date().toISOString()}).eq("auth_user_id",e);return r?(console.error("❌ [DEBUG onboardingService] Error marking profile setup complete:",r),!1):(console.log("✅ [DEBUG onboardingService] Profile setup marked complete with onboarding status"),!0)}catch(r){return console.error("❌ [DEBUG onboardingService] Error marking profile setup complete:",r),!1}}async markWelcomeMessageShown(e){return this.updateOnboardingStatus(e,"complete",{welcome_message_shown:!0,timestamp:new Date().toISOString()})}async markOnboardingComplete(e){return this.updateOnboardingStatus(e,"complete",{onboarding_complete:!0,timestamp:new Date().toISOString()})}getBooleanValue(e,t=!1){return e==null?t:!!e}getNextOnboardingStepFromUser(e){const t=this.getBooleanValue(e.hasSeenSplashScreens),r=this.getBooleanValue(e.hasSeenHowToUse),s=this.getBooleanValue(e.hasSeenFeaturesConnected),o=this.getBooleanValue(e.hasSeenProFeatures),n=this.getBooleanValue(e.pcConnected),i=this.getBooleanValue(e.pcConnectionSkipped);return t?t&&!r?"how-to-use":r&&n&&!s?"features-connected":r&&!n&&i&&!o?"pro-features":r&&!n&&!i?"how-to-use":s&&!o?"pro-features":o?"complete":(console.error("🎯 [OnboardingService] ERROR: Unexpected onboarding flow state",{hasSeenSplashScreens:t,hasSeenHowToUse:r,hasSeenFeaturesConnected:s,hasSeenProFeatures:o,pcConnected:n,pcConnectionSkipped:i}),"how-to-use"):"initial"}async getNextOnboardingStep(e){try{const t=await this.getOnboardingStatus(e);if(!t)return"login";const r=this.getBooleanValue(t.has_seen_splash_screens),s=this.getBooleanValue(t.has_seen_how_to_use),o=this.getBooleanValue(t.has_seen_features_connected),n=this.getBooleanValue(t.has_seen_pro_features),i=this.getBooleanValue(t.pc_connected),c=this.getBooleanValue(t.pc_connection_skipped);return r?r&&!s?"how-to-use":s&&i&&!o?"features-connected":s&&!i&&c&&!n?"pro-features":s&&!i&&!c?"how-to-use":o&&!n?"pro-features":n?"complete":(console.error("🎯 [OnboardingService] ERROR: Unexpected onboarding flow state",{hasSeenSplashScreens:r,hasSeenHowToUse:s,hasSeenFeaturesConnected:o,hasSeenProFeatures:n,pcConnected:i,pcConnectionSkipped:c}),"how-to-use"):"initial"}catch(t){return console.error("🎯 [OnboardingService] Error getting next onboarding step:",t),"login"}}async shouldShowOnboarding(e){try{const t=await this.getOnboardingStatus(e);return t?!t.onboarding_completed:!0}catch(t){return console.error("Error checking if should show onboarding:",t),!0}}async trackOnboardingStep(e,t,r,s={}){try{await l.from("user_analytics").insert({user_id:e,auth_user_id:e,event_type:"onboarding_step",event_data:ee({step:t,action:r,data:s,timestamp:new Date().toISOString()})})}catch(o){console.error("Error tracking onboarding step:",o)}}async trackOnboardingDropOff(e,t,r,s={}){try{await l.from("user_analytics").insert({user_id:e,auth_user_id:e,event_type:"onboarding_dropoff",event_data:ee({step:t,reason:r,data:s,timestamp:new Date().toISOString()})})}catch(o){console.error("Error tracking onboarding dropoff:",o)}}async resetOnboarding(e){try{const{error:t}=await l.from("onboarding_progress").delete().eq("user_id",e);if(t)return console.error("Error clearing onboarding progress:",t),!1;const{error:r}=await l.from("users").update({is_new_user:!0,has_seen_splash_screens:!1,has_profile_setup:!1,has_welcome_message:!1,onboarding_completed:!1,onboarding_data:{}}).eq("id",e);return r?(console.error("Error resetting user onboarding flags:",r),!1):!0}catch(t){return console.error("Error resetting onboarding:",t),!1}}async getOnboardingStats(){try{const{count:e}=await l.from("users").select("*",{count:"exact",head:!0}),{count:t}=await l.from("users").select("*",{count:"exact",head:!0}).eq("onboarding_completed",!0),{data:r}=await l.from("user_analytics").select("event_data").eq("event_type","onboarding_dropoff"),s={};return r&&r.forEach(o=>{const n=o.event_data;if(typeof n=="object"&&n!==null&&!Array.isArray(n)){const i=n.step;typeof i=="string"&&(s[i]=(s[i]||0)+1)}}),{total_users:e||0,completed_onboarding:t||0,dropoff_by_step:s}}catch(e){return console.error("Error getting onboarding stats:",e),{total_users:0,completed_onboarding:0,dropoff_by_step:{}}}}};b(Y,"instance");let we=Y;const Ot=we.getInstance(),Qr=Object.freeze(Object.defineProperty({__proto__:null,onboardingService:Ot},Symbol.toStringTag,{value:"Module"}));let T=null;const vt="wss://otakon-relay.onrender.com";let te=0;const Ct=5e3,_e=[];let ge=null,y=null,k=null,me=!0;const It=3e4,Nt=(a,e,t,r,s)=>{if(T&&(T.readyState===WebSocket.OPEN||T.readyState===WebSocket.CONNECTING))return;if(!/^\d{6}$/.test(a)){const n="Invalid code format. Please enter a 6-digit code.";r(n),R.error(n);return}ge=a,y={onOpen:e,onMessage:t,onError:r,onClose:s},me=!0;const o=`${vt}/${a}`;try{T=new WebSocket(o)}catch(n){const c=`Connection failed: ${n instanceof Error?n.message:"An unknown error occurred."}. Please check the URL and your network connection.`;r(c),R.error("PC connection failed. Please check your network and try again.");return}T.onopen=()=>{console.log("🔗 [WebSocket] Connection opened successfully to",o),te=0,y&&typeof y.onOpen=="function"&&y.onOpen();try{T==null||T.send(JSON.stringify({type:"connection_request",code:a,ts:Date.now()})),console.log("🔗 [WebSocket] Sent connection_request with code:",a)}catch(n){console.error("🔗 [WebSocket] Failed to send connection_request:",n)}for(;_e.length&&T&&T.readyState===WebSocket.OPEN;){const n=_e.shift();try{T.send(JSON.stringify(n)),console.log("🔗 [WebSocket] Sent queued message:",n==null?void 0:n.type)}catch(i){console.error("🔗 [WebSocket] Failed to send queued message:",i)}}k&&(clearInterval(k),k=null),k=window.setInterval(()=>{if(T&&T.readyState===WebSocket.OPEN)try{T.send(JSON.stringify({type:"ping",ts:Date.now()}))}catch{}},It)},T.onmessage=n=>{var i;try{const c=JSON.parse(n.data);if(console.log("🔗 [WebSocket] Message received:",{type:c.type||"unknown",hasDataUrl:!!c.dataUrl,dataUrlLength:(i=c.dataUrl)==null?void 0:i.length,keys:Object.keys(c)}),c.type==="error"||c.error){const u=c.message||c.error||"Connection failed";console.error("🔗 [WebSocket] Server error:",u),localStorage.removeItem("otakon_connection_code"),localStorage.removeItem("otakon_last_connection"),y&&typeof y.onError=="function"&&y.onError(u);return}if(c.type==="no_partner"||c.type==="partner_not_found"||c.type==="invalid_code"){const u="No PC client found with this code. Please check the code and ensure the PC client is running.";console.error("🔗 [WebSocket] No partner found:",c),localStorage.removeItem("otakon_connection_code"),localStorage.removeItem("otakon_last_connection"),y&&typeof y.onError=="function"&&y.onError(u);return}if((c.type==="partner_disconnected"||c.type==="partner_left"||c.type==="peer_disconnected")&&console.log("🔗 [WebSocket] Partner disconnected - PC app closed or lost connection"),(c.type==="screenshot_success"||c.type==="screenshot_batch"||c.type==="screenshot")&&console.log("🔗 [WebSocket] Full screenshot message:",JSON.stringify(c).substring(0,500)),y&&typeof y.onMessage=="function"){console.log("🔗 [WebSocket] Invoking onMessage handler with data:",c.type);try{y.onMessage(c),console.log("🔗 [WebSocket] Handler completed successfully")}catch(u){console.error("🔗 [WebSocket] Handler threw error:",u)}}else console.error("🔗 [WebSocket] No valid onMessage handler!",y)}catch(c){console.error("🔗 [WebSocket] Failed to parse message:",n.data,c)}},T.onerror=()=>{},T.onclose=n=>{if(console.log("🔗 [WebSocket] Connection closed:",{wasClean:n.wasClean,code:n.code,reason:n.reason}),!n.wasClean){let i="Connection closed unexpectedly.";n.code===1006?(i="Connection to the server failed. Please check your network, verify the code, and ensure the PC client is running.",te===0&&R.warning("PC connection lost. Attempting to reconnect...")):n.reason&&(i=`Connection closed: ${n.reason}`),y&&typeof y.onError=="function"&&y.onError(i)}if(T=null,y&&typeof y.onClose=="function"&&y.onClose(),k&&(clearInterval(k),k=null),me&&ge&&y){te+=1;const i=Math.min(Ct,500*Math.pow(2,te-1)),c=Math.random()*300,u=i+c;setTimeout(()=>{!T&&y&&me&&Nt(ge,y.onOpen,y.onMessage,y.onError,y.onClose)},u)}}},Zr=a=>{T&&T.readyState===WebSocket.OPEN?T.send(JSON.stringify(a)):_e.push(a)},es=()=>{me=!1,T&&(T.close(1e3,"User disconnected"),T=null),te=0,k&&(clearInterval(k),k=null),ge=null,y=null},ts=(a,e,t,r)=>{y={onOpen:a,onMessage:e,onError:t,onClose:r},console.log("🔗 [WebSocket] Handlers updated")};class rs{static async addToWaitlist(e,t="landing_page"){try{const{data:r,error:s}=await l.from("waitlist").insert({email:e,source:t,status:"pending"}).select();if(s){if(console.error("Error adding to waitlist:",s),console.error("Insert error details:",{message:s.message,code:s.code,details:s.details,hint:s.hint}),s.code==="23505")return{success:!0,alreadyExists:!0,error:"You're already on our waitlist! We'll email you when access is ready."};const{data:o,error:n}=await l.from("waitlist").select("email, status, created_at").eq("email",e).maybeSingle();return n?(console.error("Error checking existing email:",n),{success:!1,error:`Failed to add to waitlist: ${s.message}`}):o?{success:!0,alreadyExists:!0,error:"You're already on our waitlist! We'll email you when access is ready."}:{success:!1,error:`Failed to add to waitlist: ${s.message}`}}return{success:!0,alreadyExists:!1,error:void 0}}catch(r){return console.error("Waitlist service error:",r),{success:!1,error:"An unexpected error occurred"}}}static async getWaitlistCount(){try{const{count:e,error:t}=await l.from("waitlist").select("*",{count:"exact",head:!0});return t?(console.error("Error getting waitlist count:",t),{error:"Failed to get count"}):{count:e||0}}catch(e){return console.error("Error getting waitlist count:",e),{error:"Failed to get count"}}}static async getWaitlistStats(){try{const{data:e,error:t}=await l.from("waitlist").select("status");if(t)return console.error("Error fetching waitlist stats:",t),{total:137,pending:137,invited:0,converted:0};const r={total:e.length,pending:0,invited:0,converted:0};return e.forEach(s=>{const o=s.status||"pending";o==="pending"?r.pending++:o==="approved"?r.invited++:o==="rejected"&&r.converted++}),r}catch(e){return console.error("Error fetching waitlist stats:",e),{total:137,pending:137,invited:0,converted:0}}}}const he={storeId:"254556",productId:"724192",variants:{pro:"1139861",vanguard_pro:"1139844"},storeUrl:"https://otagon.lemonsqueezy.com"},kt={pro:{name:"Pro",price:5,currency:"USD",interval:"month",variantId:he.variants.pro,features:["350 text queries / month","150 image queries / month","Advanced AI capabilities","Batch screenshot analysis","Hands-free voice mode","Priority support","No advertisements"],limits:{text:350,image:150}},vanguard_pro:{name:"Vanguard Pro",price:35,currency:"USD",interval:"year",variantId:he.variants.vanguard_pro,features:["Everything in Pro","Save 42% vs monthly","Lifetime price guarantee","Exclusive Founder's Badge","Early access to new features","VIP Discord role"],limits:{text:350,image:150}}};async function Rt(a,e,t){var r,s;try{const o="eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..5uYpaLv5p6L4F_nTzFqXTUBpexvg3mJkQfWAUiXHFJv55J42EZw3tCUzRTtQ93U17mnZbljpUqS_PS6ZcOwuFDHNLdBIqhsNezewFo0T6nKvZ24DSTiKLprChwlhlW_nBwhv3dH9AWlRfnAN9eezwkVMVE0EsqzcZ1xhyBwBS8vCHblcVBLwetR8g2XW1hvQnhHESVtA7vS7sHHDGLJmE8r0bOS-fnvrj650XzOVrqcS0cllDK999uto2zbWNHupN08C0XPr_YPkeiIAMHFtMyBT13LWBtLqI0TScqAK7JkBISr_XaYCcw5gI-Np1YoCYkNk_boXbqoyUSFo4eFENlhdySda_-y9aVF9ibIMmSZH9TD8kiPOOJEDfoOnzeUN61kbqaAXQVZpKEdxHjUq3yKcd1-xxHmH7GuU8doOqhStKpLedNgk0_P5CiYjJnr9YBPOuRM0viauNH58KU8uVF6nSsKcDTiYBFwJrDtvLy_VC3sw1tmU7nQOK662kofh6ek8JDKXzX9qnTMlW_huf9SpUlAgmLUzl26brtvx-1WzeFAreXNRmXhkbRNoK2gdpRPuBTXb8g1hje18J7XUGefSAN5EIitWiJfQrXKUZHujZv9U6WPxumGP2UcVr56LTpEeZ5ZhuPhr0CVZqXCcmE6Fqs9FwbibJ71GUjdfU6c",n=he.storeId;if(console.log("🔄 Creating checkout via API..."),console.log("   API Key present:",!!o),console.log("   Store ID:",n),console.log("   Variant ID:",a),console.log("   User Email:",e.email),!a)throw new Error("Variant ID is missing");const i={data:{type:"checkouts",attributes:{checkout_data:{email:e.email,custom:{auth_user_id:e.authUserId,user_id:e.id}},checkout_options:{embed:!0,button_color:"#6366f1"},product_options:{redirect_url:t||`${window.location.origin}/payment-success`}},relationships:{store:{data:{type:"stores",id:String(n)}},variant:{data:{type:"variants",id:String(a)}}}}};console.log("📤 API Payload:",JSON.stringify(i,null,2));const c=await fetch("https://api.lemonsqueezy.com/v1/checkouts",{method:"POST",headers:{Accept:"application/vnd.api+json","Content-Type":"application/vnd.api+json",Authorization:`Bearer ${o}`},body:JSON.stringify(i)});if(console.log("📥 API Response Status:",c.status),!c.ok){let E=c.statusText;try{const p=await c.json();console.error("❌ Checkouts API Error Response:",p),E=((s=(r=p.errors)==null?void 0:r[0])==null?void 0:s.detail)||p.message||c.statusText}catch(p){console.error("❌ Failed to parse error response:",p)}throw new Error(`Failed to create checkout: ${E} (Status: ${c.status})`)}const u=await c.json();console.log("📥 API Response Data:",u);const f=u.data.attributes.url;if(!f)throw new Error("No checkout URL in response");return console.log("✅ Checkout URL created:",f),f}catch(o){throw console.error("❌ Error creating checkout URL:",o),o}}let N,Fe=!1;function Pt(){if(!Fe){if(typeof window.createLemonSqueezy=="function"&&(console.log("🍋 Calling createLemonSqueezy()"),window.createLemonSqueezy()),!window.LemonSqueezy){console.warn("LemonSqueezy SDK not available after initialization");return}console.log("🍋 Setting up LemonSqueezy event handler"),window.LemonSqueezy.Setup({eventHandler:a=>{console.log("🍋 LemonSqueezy Event:",a.event,a),a.event==="Checkout.Success"?(console.log("✅ Checkout completed successfully - calling onSuccess callback"),N!=null&&N.onSuccess&&N.onSuccess(),N=void 0):a.event==="Checkout.Close"&&(console.log("❌ Checkout closed - calling onClose callback"),N!=null&&N.onClose&&N.onClose(),N=void 0)}}),Fe=!0,console.log("🍋 LemonSqueezy initialized successfully")}}async function ss(a,e){const{tier:t,user:r,redirectUrl:s}=a,n=kt[t].variantId;if(!n)throw new Error(`No variant ID configured for tier: ${t}`);if(!window.LemonSqueezy)throw console.error("LemonSqueezy SDK not loaded. Make sure lemon.js script is included in your HTML."),new Error("LemonSqueezy SDK not available");try{console.log("🔄 Creating checkout URL via API..."),console.log("   Variant ID:",n),console.log("   Tier:",t),console.log("   User:",r.email),Pt(),N=e;const i=await Rt(n,r,s);console.log("✅ Checkout URL created:",i),console.log("🔗 Opening LemonSqueezy checkout overlay..."),window.LemonSqueezy.Url.Open(i)}catch(i){throw console.error("❌ Error opening LemonSqueezy checkout:",i),i}}function as(){return`${he.storeUrl}/billing`}const os=a=>{const e=new Map;let t=a;console.log(`🏷️ [otakonTags] Parsing response (${a.length} chars)...`);const r=[/\*\*Internal Data Structure\*\*:?\s*\n*\s*```json\s*([\s\S]*?)```/i,/\*\*Internal Data Structure\*\*:?\s*\n*\s*```\s*([\s\S]*?)```/i,/Internal Data Structure:?\s*\n*\s*```json\s*([\s\S]*?)```/i,/Internal Data Structure:?\s*\n*\s*```\s*([\s\S]*?)```/i,/Internal Data Structure:?\s*\n*(\{[\s\S]*?\})\s*```/i,/Internal Data Structure:?\s*\n*(\{[\s\S]*?"followUpPrompts"[\s\S]*?\})\s*$/i,/"Internal Data Structure":?\s*\n*(\{[\s\S]*?"followUpPrompts"[\s\S]*?\})/i];for(const h of r){const S=a.match(h);if(S&&S[1])try{const d=S[1].trim(),m=JSON.parse(d);if(console.log("🏷️ [otakonTags] Found Internal Data Structure JSON:",Object.keys(m)),m.followUpPrompts&&Array.isArray(m.followUpPrompts)&&(e.set("SUGGESTIONS",m.followUpPrompts),console.log("🏷️ [otakonTags] ✅ Extracted followUpPrompts from JSON:",m.followUpPrompts)),m.stateUpdateTags&&Array.isArray(m.stateUpdateTags))for(const A of m.stateUpdateTags){const w=String(A).match(/PROGRESS[:\s]+(\d+)/i);if(w){const x=parseInt(w[1],10);x>=0&&x<=100&&(e.set("PROGRESS",x),console.log(`📊 [otakonTags] ✅ Extracted PROGRESS from stateUpdateTags: ${x}%`))}const I=String(A).match(/OBJECTIVE[:\s]+(.+)/i);I&&(e.set("OBJECTIVE",I[1].trim()),console.log("🎯 [otakonTags] ✅ Extracted OBJECTIVE from stateUpdateTags"))}m.progressiveInsightUpdates&&Array.isArray(m.progressiveInsightUpdates)&&(e.set("SUBTAB_UPDATE",m.progressiveInsightUpdates),console.log(`📑 [otakonTags] ✅ Extracted ${m.progressiveInsightUpdates.length} subtab updates from JSON`));break}catch(d){console.warn("[otakonTags] Failed to parse Internal Data Structure JSON:",d)}}if(!e.has("SUGGESTIONS")){const h=a.match(/\{[\s\S]*?"followUpPrompts"\s*:\s*\[([\s\S]*?)\][\s\S]*?\}/);if(h)try{const S=a.indexOf(h[0]);let d=0,m=S;for(let I=S;I<a.length;I++)if(a[I]==="{"&&d++,a[I]==="}"&&(d--,d===0)){m=I+1;break}const A=a.substring(S,m),w=JSON.parse(A);w.followUpPrompts&&Array.isArray(w.followUpPrompts)&&(e.set("SUGGESTIONS",w.followUpPrompts),console.log("🏷️ [otakonTags] ✅ Extracted followUpPrompts from embedded JSON:",w.followUpPrompts))}catch{try{const d=a.match(/"followUpPrompts"\s*:\s*\[([^\]]+)\]/);if(d){const m=JSON.parse(`[${d[1]}]`);Array.isArray(m)&&m.length>0&&(e.set("SUGGESTIONS",m),console.log("🏷️ [otakonTags] ✅ Extracted followUpPrompts array:",m))}}catch{console.warn("[otakonTags] Could not extract followUpPrompts from JSON")}}}const s=/\[OTAKON_SUGGESTIONS:\s*(\[[\s\S]*?\])\s*\]/g;let o;for(;(o=s.exec(a))!==null;)try{const h=o[1];try{const m=JSON.parse(h);if(Array.isArray(m)){e.set("SUGGESTIONS",m),t=t.replace(o[0],""),console.log("🏷️ [otakonTags] Extracted SUGGESTIONS:",m);continue}}catch{}const S=h.replace(/'/g,'"'),d=JSON.parse(S);e.set("SUGGESTIONS",d),t=t.replace(o[0],""),console.log("🏷️ [otakonTags] Extracted SUGGESTIONS:",d)}catch{console.warn("[OtakonTags] Failed to parse SUGGESTIONS JSON:",o[1])}const n=/\[OTAKON_SUBTAB_UPDATE:\s*\{[^\]]*\}\s*\]/g;let i;const c=[];for(;(i=n.exec(a))!==null;){try{const h=i[0].match(/\{[^\]]*\}/);if(h){const S=JSON.parse(h[0]);c.push(S)}}catch{console.warn("[OtakonTags] Failed to parse SUBTAB_UPDATE JSON:",i[0])}t=t.replace(i[0],"")}c.length>0&&e.set("SUBTAB_UPDATE",c);const u=/\[OTAKON_SUBTAB_CONSOLIDATE:\s*\{[^\]]*\}\s*\]/g;let f;const E=[];for(;(f=u.exec(a))!==null;){try{const h=f[0].match(/\{[^\]]*\}/);if(h){const S=JSON.parse(h[0]);E.push(S),console.log("📦 [otakonTags] Extracted SUBTAB_CONSOLIDATE:",S)}}catch{console.warn("[OtakonTags] Failed to parse SUBTAB_CONSOLIDATE JSON:",f[0])}t=t.replace(f[0],"")}E.length>0&&e.set("SUBTAB_CONSOLIDATE",E);let p=null;const O=a.match(/\[OTAKON_PROGRESS[:\s]+(\d+)/i);if(O&&(p=parseInt(O[1],10),console.log(`📊 [otakonTags] Found OTAKON_PROGRESS format: ${O[0]} → ${p}%`)),p===null){const h=a.match(/\[?PROGRESS[:\s]+(\d+)/i);h&&(p=parseInt(h[1],10),console.log(`📊 [otakonTags] Found PROGRESS format: ${h[0]} → ${p}%`))}if(p===null){const h=a.match(/(?:progress|completion|game progress)[:\s]+(?:approximately\s+)?(\d+)\s*%/i);h&&(p=parseInt(h[1],10),console.log(`📊 [otakonTags] Found inline progress format: ${h[0]} → ${p}%`))}if(p===null){const h=a.match(/"stateUpdateTags"[^}]*"PROGRESS[:\s]+(\d+)/i);h&&(p=parseInt(h[1],10),console.log(`📊 [otakonTags] Found stateUpdateTags PROGRESS: ${h[0]} → ${p}%`))}p!==null&&p>=0&&p<=100?(e.set("PROGRESS",p),console.log(`📊 [otakonTags] ✅ Set PROGRESS tag to: ${p}%`)):console.log("📊 [otakonTags] ⚠️ No valid progress found in response");const P=a.match(/\[OTAKON_TTS_START\]([\s\S]*?)\[OTAKON_TTS_END\]/i);if(P&&P[1]){const h=P[1].trim();e.set("TTS_CONTENT",h),t=t.replace(P[0],""),console.log(`🔊 [otakonTags] Extracted TTS_CONTENT (${h.length} chars):`,h.substring(0,50)+"...")}const be=/\[OTAKON_([A-Z_]+):\s*([^[\]]+?)\]/g;let D;for(;(D=be.exec(a))!==null;){const h=D[1];let S=D[2].trim();if(console.log(`🏷️ [otakonTags] Found tag: ${h} = ${D[2].substring(0,50)}`),!(h==="SUGGESTIONS"||h==="SUBTAB_UPDATE"||h==="TTS_START"||h==="TTS_END")){try{const d=S;d.startsWith("{")&&d.endsWith("}")&&(S=JSON.parse(d)),d.startsWith("[")&&d.endsWith("]")&&(S=JSON.parse(d.replace(/'/g,'"')))}catch{}if(h==="PROGRESS"){const d=String(S).trim(),m=d.match(/(\d+)/);if(m){const A=parseInt(m[1],10);S=Math.min(100,Math.max(0,A)),console.log(`📊 [otakonTags] Parsed PROGRESS: "${d}" → ${S}`)}else console.warn(`📊 [otakonTags] Could not parse PROGRESS value: "${d}"`)}e.set(h,S),t=t.replace(D[0],"")}}return t=t.replace(/^I['']?m\s+Otagon,\s+your\s+dedicated\s+gaming\s+lore\s+expert[^\n]*\n*/i,"").replace(/\[OTAKON_SUGGESTIONS:[^\]]*\]/gi,"").replace(/\[OTAKON_[A-Z_]+:[^\]]*\]/g,"").replace(/\*\*Internal Data Structure\*\*[\s\S]*$/gi,"").replace(/\*+\s*#+\s*Internal Data Structure[\s\S]*$/gi,"").replace(/\*+\s*Internal Data Structure[\s\S]*$/gi,"").replace(/#+\s*Internal Data Structure[\s\S]*$/gi,"").replace(/Internal Data Structure:?[\s\S]*$/gi,"").replace(/"Internal Data Structure":?[\s\S]*$/gi,"").replace(/\{[\s\S]*?"followUpPrompts"[\s\S]*?\}\s*$/gi,"").replace(/\{[\s\S]*?"progressiveInsightUpdates"[\s\S]*?\}\s*$/gi,"").replace(/\{[\s\S]*?"stateUpdateTags"[\s\S]*?\}\s*$/gi,"").replace(/\{[\s\S]*?"gamePillData"[\s\S]*?\}\s*$/gi,"").replace(/```json[\s\S]*?```/gi,"").replace(/```\s*\{[\s\S]*?```/gi,"").replace(/\]\s*$/g,"").replace(/\}\s*$/g,"").replace(/\\n/g,`
`).replace(/"\s*\}\s*\]\s*$/g,"").replace(/"\s*\]\s*$/g,"").trim(),e.size>0&&console.log(`🏷️ [otakonTags] Extracted ${e.size} tags:`,Array.from(e.keys()).join(", ")),{cleanContent:t,tags:e}},q=class q{static getInstance(){return q.instance||(q.instance=new q),q.instance}generateCacheKey(e,t){var n;const r={prompt:e.trim().toLowerCase(),gameTitle:(n=t.gameTitle)==null?void 0:n.toLowerCase(),mode:t.mode},s=JSON.stringify(r);let o=0;for(let i=0;i<s.length;i++){const c=s.charCodeAt(i);o=(o<<5)-o+c,o=o&o}return Math.abs(o).toString(36)}async getCachedResponse(e){try{const{data:t,error:r}=await l.from("ai_responses").select("response_data, created_at, model_used, tokens_used, cache_type").eq("cache_key",e).gt("expires_at",new Date().toISOString()).single();if(r)return r.code==="PGRST116"?(console.log("❌ [aiCacheService] Cache MISS:",e.substring(0,8)),null):(console.error("❌ [aiCacheService] Error checking cache:",r),null);if(t){const s=t.created_at?Math.floor((Date.now()-new Date(t.created_at).getTime())/1e3/60):0;return console.log("✅ [aiCacheService] Cache HIT:",e.substring(0,8),{age:`${s}m`,model:t.model_used,tokens:t.tokens_used,type:t.cache_type}),t.response_data}return null}catch(t){return console.error("Error in getCachedResponse:",t),null}}async cacheResponse(e,t,r){try{const s=new Date;s.setHours(s.getHours()+r.ttlHours);const{data:{user:o}}=await l.auth.getUser(),{error:n}=await l.from("ai_responses").upsert({cache_key:e,response_data:JSON.parse(JSON.stringify(t)),game_title:r.gameTitle,cache_type:r.cacheType,conversation_id:r.conversationId,model_used:r.modelUsed,tokens_used:r.tokensUsed,user_id:o==null?void 0:o.id,expires_at:s.toISOString(),created_at:new Date().toISOString()},{onConflict:"cache_key"});return n?(console.error("Error caching response:",n),!1):(console.log("💾 Cached response:",e.substring(0,8),{type:r.cacheType,ttl:r.ttlHours+"h",tokens:r.tokensUsed,game:r.gameTitle}),!0)}catch(s){return console.error("Error in cacheResponse:",s),!1}}determineCacheType(e){return e.gameTitle?"game_specific":e.hasUserContext||e.conversationId?"user":"global"}determineTTL(e,t){switch(e){case"global":return 168;case"game_specific":return 24;case"user":return 12;default:return 24}}shouldCache(e,t){if(console.log(`🔍 [aiCacheService] shouldCache called with prompt: "${e.substring(0,50)}..."`,t),t.noCache===!0)return!1;if(e.trim().length<10)return console.log(`❌ [aiCacheService] Not caching: prompt too short (${e.trim().length} chars)`),!1;const r=["today","now","current","latest","recent","just released"],s=e.toLowerCase();return!r.find(n=>s.includes(n))}async cleanupExpiredCache(){try{const{data:e,error:t}=await l.from("ai_responses").delete().lt("expires_at",new Date().toISOString()).select("id");return t?(console.error("Error cleaning up cache:",t),{deleted:0}):{deleted:(e==null?void 0:e.length)||0}}catch(e){return console.error("Error in cleanupExpiredCache:",e),{deleted:0}}}async getCacheStats(){try{const{data:e,error:t}=await l.from("ai_responses").select("cache_type, tokens_used").gt("expires_at",new Date().toISOString());if(t)return console.error("Error getting cache stats:",t),{totalEntries:0,byType:{},totalTokensSaved:0};const r={totalEntries:e.length,byType:{},totalTokensSaved:e.reduce((s,o)=>s+(o.tokens_used||0),0)};return e.forEach(s=>{const o=s.cache_type||"unknown";r.byType[o]=(r.byType[o]||0)+1}),r}catch(e){return console.error("Error in getCacheStats:",e),{totalEntries:0,byType:{},totalTokensSaved:0}}}async invalidateGameCache(e){try{const{error:t}=await l.from("ai_responses").delete().eq("game_title",e).eq("cache_type","game_specific");return t?(console.error("Error invalidating game cache:",t),!1):!0}catch(t){return console.error("Error in invalidateGameCache:",t),!1}}};b(q,"instance");let Ae=q;const ns=Ae.getInstance(),z=class z{constructor(){}static getInstance(){return z.instance||(z.instance=new z),z.instance}generateProfileSpecificTabs(e,t){const r=[];return e.playerFocus==="Story-Driven"&&r.push({id:"narrative_themes",title:"Narrative Themes",type:"story",priority:"high",isProfileSpecific:!0,instruction:this.getNarrativeThemesInstruction(e.hintStyle)}),e.playerFocus==="Completionist"&&r.push({id:"secret_hunting",title:"Secret Hunting",type:"tips",priority:"high",isProfileSpecific:!0,instruction:this.getSecretHuntingInstruction(e.hintStyle)}),e.playerFocus==="Strategist"&&r.push({id:"optimization_guide",title:"Optimization Guide",type:"strategies",priority:"high",isProfileSpecific:!0,instruction:this.getOptimizationInstruction(e.hintStyle)}),t!=null&&t.playthroughCount&&t.playthroughCount>1&&r.push({id:"playthrough_comparison",title:"Playthrough Comparison",type:"tips",priority:"medium",isProfileSpecific:!0,instruction:this.getPlaythroughComparisonInstruction(e)}),r}getNarrativeThemesInstruction(e){const t={Cryptic:"Provide subtle hints about story themes without revealing major plot points. Use metaphorical language and thematic connections.",Balanced:"Discuss narrative elements with moderate detail, balancing spoiler avoidance with meaningful insight into themes and character arcs.",Direct:"Explain story themes clearly while maintaining appropriate spoiler warnings. Provide direct analysis of narrative elements encountered so far."};return t[e]||t.Balanced}getSecretHuntingInstruction(e){const t={Cryptic:"Give mysterious clues about hidden content locations. Use environmental riddles and subtle hints that require exploration.",Balanced:"Provide clear directions to secrets with some exploration challenge. Balance helpfulness with maintaining the joy of discovery.",Direct:"Give precise locations and requirements for finding secrets. Include step-by-step instructions and exact coordinates when helpful."};return t[e]||t.Balanced}getOptimizationInstruction(e){const t={Cryptic:"Suggest optimization strategies through hints and examples. Let the player discover the optimal path with guidance.",Balanced:"Provide balanced optimization advice with clear explanations. Suggest effective approaches while leaving room for experimentation.",Direct:"Give specific optimization recommendations with detailed steps. Provide exact stat allocations, builds, and strategies for maximum efficiency."};return t[e]||t.Direct}getPlaythroughComparisonInstruction(e){return`Compare different playthrough approaches based on ${e.playerFocus} style and ${e.hintStyle} preferences. Highlight what's different this time and suggest new strategies to explore.`}prioritizeTabsForProfile(e,t){return e.sort((r,s)=>{if(r.isProfileSpecific&&!s.isProfileSpecific)return-1;if(!r.isProfileSpecific&&s.isProfileSpecific)return 1;const o={high:3,medium:2,low:1};return o[s.priority]-o[r.priority]})}getHintStyleModifier(e){const t={Cryptic:"Use subtle, metaphorical hints. Avoid direct answers. Make the player think and discover.",Balanced:"Provide clear guidance while leaving room for exploration. Balance helpfulness with discovery.",Direct:"Give explicit, step-by-step instructions. Be precise and comprehensive in explanations."};return t[e]||t.Balanced}getPlayerFocusModifier(e){const t={"Story-Driven":"Emphasize narrative elements, character development, and story context. Prioritize lore and thematic content.",Completionist:"Focus on collectibles, hidden items, side quests, and 100% completion strategies. Highlight missable content.",Strategist:"Prioritize optimal strategies, build optimization, and efficient progression. Focus on mechanics and systems."};return t[e]||t.Strategist}getSpoilerToleranceModifier(e){const t={Strict:"NEVER mention future events, characters, or plot points. Only discuss content up to current progress.",Moderate:"You may hint at upcoming content in vague terms, but avoid specific spoilers.",Relaxed:"You can discuss future content more freely, but still mark major spoilers clearly."};return t[e]||t.Strict}getToneModifier(e){const t={Encouraging:"Use an enthusiastic, supportive tone. Celebrate achievements and provide positive reinforcement.",Professional:"Maintain a knowledgeable, respectful tone. Provide expertise without excessive casualness.",Casual:"Use a friendly, conversational tone. Feel free to use gaming terminology and be relaxed."};return t[e]||t.Professional}buildProfileContext(e){return[`Hint Style: ${this.getHintStyleModifier(e.hintStyle)}`,`Player Focus: ${this.getPlayerFocusModifier(e.playerFocus)}`,`Spoiler Tolerance: ${this.getSpoilerToleranceModifier(e.spoilerTolerance)}`,`Tone: ${this.getToneModifier(e.preferredTone)}`].join(`
`)}getDefaultProfile(){return{hintStyle:"Balanced",playerFocus:"Strategist",preferredTone:"Professional",spoilerTolerance:"Strict"}}};b(z,"instance");let Oe=z;const Q=Oe.getInstance(),Te=new Map;async function Ye(a){const e=Te.get(a);if(e)return await e,Ye(a);let t=()=>{};const r=new Promise(s=>{t=s});return Te.set(a,r),()=>{Te.delete(a),t()}}const qe={responseHistoryScope:"game",applyCorrections:!0,correctionDefaultScope:"game"},xe={aiCorrections:[],aiPreferences:qe,responseTopicsCache:{}},Ut=20,$e=5,Ke=10;async function C(a){try{const{data:e,error:t}=await l.from("users").select("behavior_data").eq("auth_user_id",a).single();if(t)return console.error("[BehaviorService] Error fetching behavior_data:",t),xe;const r=(e==null?void 0:e.behavior_data)||{};return{aiCorrections:r.aiCorrections||[],aiPreferences:{...qe,...r.aiPreferences},responseTopicsCache:r.responseTopicsCache||{}}}catch(e){return console.error("[BehaviorService] Exception fetching behavior_data:",e),xe}}async function G(a,e){const t=await Ye(a);try{const r=await C(a),s={...r,...e,aiPreferences:e.aiPreferences?{...r.aiPreferences,...e.aiPreferences}:r.aiPreferences},{error:o}=await l.from("users").update({behavior_data:s}).eq("auth_user_id",a);return o?(console.error("[BehaviorService] Error updating behavior_data:",o),!1):!0}catch(r){return console.error("[BehaviorService] Exception updating behavior_data:",r),!1}finally{t()}}async function Gt(a,e,t="game"){if(t==="off")return[];const r=await C(a);if(t==="global")return Object.values(r.responseTopicsCache).flat().slice(0,50);const s=e||"game-hub";return r.responseTopicsCache[s]||[]}async function Dt(a,e,t){if(!t.length)return;const r=await C(a),s=e||"game-hub",o=r.responseTopicsCache[s]||[],n=[...t,...o],i=[...new Set(n)].slice(0,Ut);r.responseTopicsCache[s]=i,await G(a,{responseTopicsCache:r.responseTopicsCache})}async function Mt(a,e){const t=await C(a);if(e===void 0)await G(a,{responseTopicsCache:{}});else{const r=e||"game-hub";delete t.responseTopicsCache[r],await G(a,{responseTopicsCache:t.responseTopicsCache})}}async function Lt(a){return(await C(a)).aiPreferences}async function Ft(a,e){const t=await C(a);return G(a,{aiPreferences:{...t.aiPreferences,...e}})}async function xt(a,e=null,t=!0){return(await C(a)).aiCorrections.filter(s=>s.isActive?s.scope==="game"?s.gameTitle===e:t&&s.scope==="global":!1)}async function $t(a,e){const t=await C(a),r=t.aiCorrections.filter(i=>i.isActive&&i.scope==="game"&&i.gameTitle===e.gameTitle),s=t.aiCorrections.filter(i=>i.isActive&&i.scope==="global");if(e.scope==="game"&&r.length>=$e)return{success:!1,error:`Maximum ${$e} corrections per game reached`};if(e.scope==="global"&&s.length>=Ke)return{success:!1,error:`Maximum ${Ke} global corrections reached`};const o={...e,id:crypto.randomUUID(),isActive:!0,appliedCount:0,createdAt:new Date().toISOString()};return t.aiCorrections.push(o),{success:await G(a,{aiCorrections:t.aiCorrections})}}async function Kt(a,e,t){const r=await C(a),s=r.aiCorrections.find(o=>o.id===e);return s?(s.isActive=t,G(a,{aiCorrections:r.aiCorrections})):!1}async function Wt(a,e){const t=await C(a);return t.aiCorrections=t.aiCorrections.filter(r=>r.id!==e),G(a,{aiCorrections:t.aiCorrections})}async function Bt(a,e){const t=await C(a),r=t.aiCorrections.find(s=>s.id===e);r&&(r.appliedCount++,await G(a,{aiCorrections:t.aiCorrections}))}const U={getBehaviorData:C,updateBehaviorData:G,getResponseTopics:Gt,addResponseTopics:Dt,clearResponseTopics:Mt,getAIPreferences:Lt,updateAIPreferences:Ft,getActiveCorrections:xt,addCorrection:$t,toggleCorrection:Kt,removeCorrection:Wt,incrementCorrectionApplied:Bt},Ht=1440*60*1e3,is={async getCache(a){try{const{data:e,error:t}=await l.from("news_cache").select("*").eq("prompt_type",a).gte("expires_at",new Date().toISOString()).order("cached_at",{ascending:!1}).limit(1).single();return t?(t.code==="PGRST116"||console.error("[NewsCache] Error fetching cache:",t),null):e?e.news_items:null}catch(e){return console.error("[NewsCache] Error in getCache:",e),null}},async setCache(a,e){try{const t=new Date,r=new Date(t.getTime()+Ht);await l.from("news_cache").delete().eq("prompt_type",a);const{error:s}=await l.from("news_cache").insert({prompt_type:a,news_items:e,cached_at:t.toISOString(),expires_at:r.toISOString()});return s?(console.error("[NewsCache] Error storing cache:",s),!1):(console.log(`[NewsCache] Stored ${e.length} items for "${a}" (expires in 24h)`),!0)}catch(t){return console.error("[NewsCache] Error in setCache:",t),!1}},async hasValidCache(a){const e=await this.getCache(a);return e!==null&&e.length>0},async clearExpired(){try{const{data:a,error:e}=await l.from("news_cache").delete().lt("expires_at",new Date().toISOString()).select();if(e)return console.error("[NewsCache] Error clearing expired:",e),0;const t=(a==null?void 0:a.length)||0;return console.log(`[NewsCache] Cleared ${t} expired entries`),t}catch(a){return console.error("[NewsCache] Error in clearExpired:",a),0}},async getCacheAge(a){try{const{data:e,error:t}=await l.from("news_cache").select("cached_at").eq("prompt_type",a).gte("expires_at",new Date().toISOString()).order("cached_at",{ascending:!1}).limit(1).single();if(t||!e)return null;const r=new Date(e.cached_at).getTime();return(Date.now()-r)/(3600*1e3)}catch{return null}}},cs={async getAll(a){try{const{data:e,error:t}=await l.from("user_library").select("*").eq("auth_user_id",a).order("date_added",{ascending:!1});return t?(console.error("[LibrarySync] Error fetching library:",t),[]):(e||[]).map(r=>({id:r.id,igdbGameId:r.igdb_game_id,gameName:r.game_title,category:r.category,platform:r.platform,personalRating:r.personal_rating,completionStatus:r.completion_status,hoursPlayed:r.hours_played?parseFloat(r.hours_played):void 0,notes:r.notes,igdbData:r.igdb_data,dateAdded:new Date(r.date_added).getTime(),updatedAt:new Date(r.updated_at).getTime()}))}catch(e){return console.error("[LibrarySync] Error in getAll:",e),[]}},async add(a,e){try{const{error:t}=await l.from("user_library").insert({auth_user_id:a,igdb_game_id:e.igdbGameId,game_title:e.gameName,category:e.category,platform:e.platform,personal_rating:e.personalRating,completion_status:e.completionStatus,hours_played:e.hoursPlayed,notes:e.notes,igdb_data:e.igdbData||{},date_added:new Date(e.dateAdded).toISOString(),updated_at:new Date(e.updatedAt).toISOString()});return t?t.code==="23505"?(console.log("[LibrarySync] Item already exists, updating instead"),this.update(a,e)):(console.error("[LibrarySync] Error adding to library:",t),!1):!0}catch(t){return console.error("[LibrarySync] Error in add:",t),!1}},async update(a,e){try{const{error:t}=await l.from("user_library").update({platform:e.platform,personal_rating:e.personalRating,completion_status:e.completionStatus,hours_played:e.hoursPlayed,notes:e.notes,igdb_data:e.igdbData||{},updated_at:new Date().toISOString()}).eq("auth_user_id",a).eq("igdb_game_id",e.igdbGameId).eq("category",e.category);return t?(console.error("[LibrarySync] Error updating library:",t),!1):!0}catch(t){return console.error("[LibrarySync] Error in update:",t),!1}},async remove(a,e,t){try{const{error:r}=await l.from("user_library").delete().eq("auth_user_id",a).eq("igdb_game_id",e).eq("category",t);return r?(console.error("[LibrarySync] Error removing from library:",r),!1):!0}catch(r){return console.error("[LibrarySync] Error in remove:",r),!1}},async syncFromLocalStorage(a,e){console.log(`[LibrarySync] Syncing ${e.length} items from localStorage to Supabase...`);for(const t of e)await this.add(a,t);console.log("[LibrarySync] Sync complete")}},ls={async getAll(a){try{const{data:e,error:t}=await l.from("user_timeline").select("*").eq("auth_user_id",a).order("event_date",{ascending:!1});return t?(console.error("[TimelineSync] Error fetching timeline:",t),[]):(e||[]).map(r=>{var s,o,n,i,c;return{id:r.id,type:r.event_type,eventDate:new Date(r.event_date).toISOString().split("T")[0],year:new Date(r.event_date).getFullYear(),title:r.event_title,description:r.event_description,specs:(s=r.event_data)==null?void 0:s.specs,photos:(o=r.event_data)==null?void 0:o.photos,igdbGameId:r.igdb_game_id,igdbData:(n=r.event_data)==null?void 0:n.igdbData,screenshotCount:(i=r.event_data)==null?void 0:i.screenshotCount,aiSummary:(c=r.event_data)==null?void 0:c.aiSummary,createdAt:new Date(r.created_at).getTime(),updatedAt:new Date(r.created_at).getTime()}})}catch(e){return console.error("[TimelineSync] Error in getAll:",e),[]}},async add(a,e){var t;try{const{error:r}=await l.from("user_timeline").insert({auth_user_id:a,event_type:e.type,event_title:e.title,event_description:e.description,event_data:{specs:e.specs,photos:e.photos,igdbData:e.igdbData,screenshotCount:e.screenshotCount,aiSummary:e.aiSummary},game_title:(t=e.igdbData)==null?void 0:t.name,igdb_game_id:e.igdbGameId,event_date:new Date(e.eventDate).toISOString(),created_at:new Date(e.createdAt).toISOString()});return r?(console.error("[TimelineSync] Error adding event:",r),!1):!0}catch(r){return console.error("[TimelineSync] Error in add:",r),!1}},async remove(a,e){try{const{error:t}=await l.from("user_timeline").delete().eq("auth_user_id",a).eq("id",e);return t?(console.error("[TimelineSync] Error removing event:",t),!1):!0}catch(t){return console.error("[TimelineSync] Error in remove:",t),!1}},async syncFromLocalStorage(a,e){console.log(`[TimelineSync] Syncing ${e.length} events from localStorage to Supabase...`);for(const t of e)await this.add(a,t);console.log("[TimelineSync] Sync complete")}},us={async getAll(a){try{const{data:e,error:t}=await l.from("user_screenshots").select("*").eq("auth_user_id",a).order("captured_at",{ascending:!1});return t?(console.error("[ScreenshotsSync] Error fetching screenshots:",t),[]):(e||[]).map(r=>({id:r.id,sessionId:"",messageId:"",conversationId:r.conversation_id||"",screenshotUrl:r.screenshot_url,aiAnalysis:"",capturedAt:new Date(r.captured_at).getTime()}))}catch(e){return console.error("[ScreenshotsSync] Error in getAll:",e),[]}},async add(a,e,t){try{const{error:r}=await l.from("user_screenshots").insert({auth_user_id:a,screenshot_url:e.screenshotUrl,game_title:t,conversation_id:e.conversationId,captured_at:new Date(e.capturedAt).toISOString()});return r?(console.error("[ScreenshotsSync] Error adding screenshot:",r),!1):!0}catch(r){return console.error("[ScreenshotsSync] Error in add:",r),!1}}};function Yt(a){const e=[];return a.interactionType==="suggested_prompt"?e.push(`
...
`),e.join(`
`)}function qt(a,e){const t=[],r=(e==null?void 0:e.messageCount)||a.messages.length,s=a.gameProgress||0,o=(e==null?void 0:e.subtabsFilled)||0,n=(e==null?void 0:e.subtabsTotal)||0;if(a.isGameHub||r<3)return"";if(r>=20?t.push(`
...
`)}
`)}return e.join(`
`)}async function ds(a,e){try{const t=await U.getAIPreferences(a);if(t.responseHistoryScope==="off")return{previousTopics:[],corrections:[],scope:"off"};const[r,s]=await Promise.all([U.getResponseTopics(a,e,t.responseHistoryScope),U.getActiveCorrections(a,e,!0)]);return{previousTopics:r,corrections:s,scope:t.responseHistoryScope}}catch(t){return console.error("[PromptSystem] Error fetching behavior context:",t),null}}const We=3e3,Vt=2e4,Ee=["story_so_far","quest_log","characters","boss_strategy","tips","hidden_secrets","points_of_interest"],ze=`
...
`;async function Ue(){try{const a=await pt.getConversations(),e=Object.values(a).filter(r=>!r.isGameHub&&r.gameTitle).map(r=>({title:r.gameTitle,genre:r.genre||"Unknown",progress:r.gameProgress||0,isUnreleased:r.isUnreleased||!1})).sort((r,s)=>r.title.localeCompare(s.title));if(e.length===0)return`
**📚 USER'S GAME LIBRARY:**
No game tabs created yet. User is new or exploring games.
`;const t=e.map(r=>{const s=r.progress>0?` (${r.progress}% progress)`:"",o=r.isUnreleased?" [UNRELEASED]":"";return`  • ${r.title} [${r.genre}]${s}${o}`}).join(`
`);return`
**📚 USER'S GAME LIBRARY (${e.length} games):**
${t}
...
`}catch(a){return console.warn("[PromptSystem] Failed to build game library context:",a),""}}const Xt=async(a,e,t,r,s)=>{var S;const o=Math.floor(a.messages.length/2);console.log(`💬 [PromptSystem] Conversation turn count: ${o}`);let n=0;const i=[],c=2500,f=[...a.subtabs||[]].filter(d=>d.status==="loaded"&&d.content).sort((d,m)=>{const A=Ee.indexOf(d.id),w=Ee.indexOf(m.id);return(A===-1?999:A)-(w===-1?999:w)}).map(d=>{const m=d.content||"";m.length>c&&m.includes("<details>")&&i.push(d.id);const A=m.length>We?m.slice(0,We)+"...[truncated]":m,w=`### ${d.title} (ID: ${d.id})
${A}`;if(n+w.length>Vt){const I=Ee.indexOf(d.id);if(I!==-1&&I<3){const x=`### ${d.title} (ID: ${d.id}) [SUMMARY]
${m.slice(0,500)}...`;return n+=x.length,x}return null}return n+=w.length,w}).filter(Boolean).join(`

`)||"No subtabs available yet.",E=i.length>0?`

**📦 SUBTAB CONSOLIDATION REQUEST:**
The following subtabs have grown large with historical content: ${i.join(", ")}
...
This keeps subtabs useful without losing important context.`:"",p=a.messages.slice(-10).map(d=>`${d.role==="user"?"User":"Otagon"}: ${d.content}`).join(`
`),O=a.contextSummary?`**Historical Context (Previous Sessions):**
${a.contextSummary}

`:"",P=s||Q.getDefaultProfile(),be=Q.buildProfileContext(P);let D="";if(a.gameTitle){const d=mt.getByGameTitle(a.gameTitle);if(d!=null&&d.igdbGameId)try{const m=await ht.getForContext(d.igdbGameId);if(m){const A=Math.ceil(m.length/4);D=`

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎮 GAME KNOWLEDGE DATABASE: "${a.gameTitle.toUpperCase()}"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

⚠️ VERIFY FIRST: Is query about "${a.gameTitle}"?
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
END OF ${a.gameTitle.toUpperCase()} KNOWLEDGE (${A} tokens)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

`,console.log(`🎮 [PromptSystem] Injecting ${m.length} chars of FULL game knowledge (no truncation)`)}}catch(m){console.warn("🎮 [PromptSystem] Failed to fetch game knowledge:",m)}}const h=await Ue();return`
**Persona: Game Companion**
You are Otagon, an immersive AI companion for the game "${a.gameTitle}".
The user's spoiler preference is: "${((S=t.preferences)==null?void 0:S.spoilerPreference)||"none"}".
...
1. **CRITICAL - GAME DETECTION OVERRIDE:**
   ...
   - **IF the query is about the current game (${a.gameTitle})**:
     * Include [OTAKON_GAME_ID: ${a.gameTitle}] [OTAKON_CONFIDENCE: high] [OTAKON_GENRE: ${a.genre}]
...
**🎨 CONVERSATION VARIETY - PREVENT REPETITION (Turn ${o}):**
${o<=4?`- Early conversation - standard format is fine
- Keep responses clear and structured`:""}
${o>4&&o<=9?`- You've had ${o} exchanges - start varying your section headers!
...
${o>9?`- Deep conversation (${o}+ turns) - be creative with section names!
...
`},Qt=async(a,e,t,r)=>{const s=r||Q.getDefaultProfile(),o=Q.buildProfileContext(s),n=await Ue(),i=a.messages.slice(-10).map(c=>`${c.role==="user"?"User":"Otagon"}: ${c.content}`).join(`
`);return`
...
**Tag Definitions:**
${Se}
`},Zt=async(a,e,t,r)=>{const s=r||Q.getDefaultProfile(),o=Q.buildProfileContext(s),n=await Ue(),i=a.gameTitle?`
...
**Tag Definitions:**
${Se}
`},gs=async(a,e,t,r,s,o,n,i,c)=>{const u=n?zt(n):"",f=i?`
**User Timezone:** ${i}
...
*Content loading...*`}}const hs=new tr,rr=`You are a correction validator for OTAKON, an AI gaming companion.
...
Is this correction valid? Respond with JSON only.`,ve="otakon_correction_submissions",re=3;function Ve(){try{const a=localStorage.getItem(ve),e=Date.now();if(!a)return{allowed:!0,remaining:re};const t=JSON.parse(a);if(e>t.resetAt)return{allowed:!0,remaining:re};const r=re-t.count;return{allowed:r>0,remaining:Math.max(0,r)}}catch{return{allowed:!0,remaining:re}}}function ar(){try{const a=localStorage.getItem(ve),e=Date.now(),t=1440*60*1e3;let r={count:0,resetAt:e+t};a&&(r=JSON.parse(a),e>r.resetAt&&(r={count:0,resetAt:e+t})),r.count++,localStorage.setItem(ve,JSON.stringify(r))}catch{}}async function je(a,e,t){if(!e.trim())return{isValid:!1,reason:"Correction text is empty"};if(e.length<5)return{isValid:!1,reason:"Correction is too short"};if(e.length>1e3)return{isValid:!1,reason:"Correction is too long (max 1000 characters)"};const r=[/\b(hate|kill|die|attack)\s+(all|every|those)\b/i,/\b(racial|ethnic)\s+slur/i,/\bviolence\s+against\b/i];for(const s of r)if(s.test(e))return{isValid:!1,reason:"Correction contains inappropriate content"};try{const{data:s,error:o}=await l.functions.invoke("gemini-chat",{body:{messages:[{role:"system",content:rr},{role:"user",content:sr(a,e,t)}],model:"gemini-3-flash-preview",temperature:.1,maxTokens:200}});if(o)return console.error("[CorrectionService] Validation API error:",o),{isValid:!1,reason:"Validation service temporarily unavailable. Please try again later."};const n=(s==null?void 0:s.content)||(s==null?void 0:s.response)||"",i=n.match(/\{[\s\S]*\}/);if(i){const c=JSON.parse(i[0]);return{isValid:c.isValid===!0,reason:c.reason||"Validation complete",suggestedType:c.suggestedType||void 0}}return console.warn("[CorrectionService] Could not parse validation response:",n),{isValid:!1,reason:"Validation response was unclear. Please try again."}}catch(s){return console.error("[CorrectionService] Validation exception:",s),{isValid:!1,reason:"Validation failed. Please try again later."}}}async function or(a,e){if(!Ve().allowed)return{success:!1,error:`Daily correction limit reached (${re}/day). Try again tomorrow.`};const r=await je(e.originalResponse,e.correctionText,e.gameTitle),{error:s}=await l.from("ai_feedback").insert({user_id:a,conversation_id:e.conversationId,message_id:e.messageId,feedback_type:"down",content_type:"message",category:"correction",comment:e.originalResponse.slice(0,500),correction_text:e.correctionText,correction_type:e.type,correction_scope:e.scope,is_validated:r.isValid,validation_reason:r.reason,game_title:e.gameTitle});if(s)return console.error("[CorrectionService] Failed to store feedback:",s),{success:!1,error:"Failed to save correction"};if(!r.isValid)return{success:!1,error:r.reason};const o=await U.addCorrection(a,{gameTitle:e.gameTitle,originalSnippet:e.originalResponse.slice(0,200),correctionText:e.correctionText,type:r.suggestedType||e.type,scope:e.scope});return o.success?(ar(),{success:!0,correction:(await U.getActiveCorrections(a,e.gameTitle)).find(c=>c.correctionText===e.correctionText)}):{success:!1,error:o.error}}const nr=[/\b(boss(?:es)?|mini-boss|final boss)\b/gi,/\b(enemy types?|elite enemies|common enemies)\b/gi,/\b(legendary weapon|rare item|unique gear)\b/gi,/\b(skill tree|ability points?|talent build)\b/gi,/\b(main quest|side quest|daily quest)\b/gi,/\b(damage build|tank build|support build|dps build)\b/gi,/\b(speedrun(?:ning)?|world record|personal best)\b/gi,/\b(secret area|hidden path|easter egg)\b/gi,/\b(tier list|meta build|optimal strategy)\b/gi,/\b(patch notes?|balance changes?|nerf(?:ed)?|buff(?:ed)?)\b/gi,/\b(dlc|expansion pack|season pass)\b/gi,/\b(game mechanics?|combat system|progression system)\b/gi,/\b(character build|loadout guide|equipment guide)\b/gi],ir=/\b([A-Z][a-z]{2,}(?:\s+(?:of|the|and)\s+)?[A-Z][a-z]{2,}(?:\s+[A-Z][a-z]+)?)\b/g;function cr(a){if(!a||a.length<100)return[];const e=new Set;for(const n of nr){const i=a.match(n);if(i)for(const c of i){const u=c.toLowerCase().trim();u.length>=6&&u.length<=50&&u.includes(" ")&&e.add(u)}}let t=0;const r=a.match(ir);if(r)for(const n of r){if(t>=5)break;const i=n.toLowerCase().trim();i.length>=6&&i.length<=40&&(e.add(i),t++)}const s=/\b(chapter|level|stage|floor|wave|round|phase|part|episode|act)\s+(\d+)\b/gi;let o;for(;(o=s.exec(a))!==null;)e.add(`${o[1].toLowerCase()} ${o[2]}`);return Array.from(e).slice(0,10)}async function lr(a){return(await U.getBehaviorData(a)).aiCorrections}async function ur(a,e){return U.getActiveCorrections(a,e,!0)}function dr(){return Ve()}const B={validateCorrection:je,submitCorrection:or,getAllCorrections:lr,getContextualCorrections:ur,getRateLimitStatus:dr,extractTopicsFromResponse:cr,toggleCorrection:U.toggleCorrection,removeCorrection:U.removeCorrection},ae={free:{gameKnowledge:0,aiMessages:4},pro:{gameKnowledge:20,aiMessages:30},vanguard_pro:{gameKnowledge:20,aiMessages:30}},Ce=new Set(["fortnite","apex legends","warzone","call of duty warzone","pubg","playerunknown's battlegrounds","league of legends","lol","dota 2","dota","smite","heroes of the storm","overwatch","overwatch 2","valorant","rainbow six siege","r6","paladins","world of warcraft","wow","final fantasy xiv","ffxiv","ff14","guild wars 2","gw2","elder scrolls online","eso","destiny 2","destiny","warframe","lost ark","new world","diablo 4","diablo iv","path of exile","poe","genshin impact","honkai star rail","zenless zone zero","zzz","wuthering waves","tower of fantasy","fifa","ea fc","fc 24","fc 25","madden","nba 2k","2k24","2k25","hearthstone","marvel snap","legends of runeterra","lor","magic arena","mtg arena","street fighter 6","sf6","tekken 8","mortal kombat 1","mk1","guilty gear strive","the finals","xdefiant","helldivers 2","sea of thieves","no man's sky","fall guys","rocket league","dead by daylight","dbd"]),Ie=new Set(["gta 6","grand theft auto 6","grand theft auto vi","monster hunter wilds","death stranding 2","death stranding 2: on the beach","ghost of yotei","like a dragon: pirate yakuza in hawaii","kingdom come deliverance 2","kingdom come 2","avowed","civilization 7","civ 7","civilization vii","fable","assassin's creed shadows","split fiction","doom: the dark ages","borderlands 4","mafia: the old country","marvel 1943","judge 0"]),Je=new Date("2025-01-31T23:59:59Z").getTime();function Xe(a){return a?a*1e3>Je:!1}function Ne(a){if(!a)return!1;const e=a.toLowerCase().trim();return Ce.has(e)||Array.from(Ce).some(t=>e.includes(t))}function ke(a){if(!a)return!1;const e=a.toLowerCase().trim();return Ie.has(e)||Array.from(Ie).some(t=>e.includes(t))}function Qe(a,e,t){const r=a.toLowerCase();if(Xe(t))return console.log("🔍 [GroundingControl] Game detected as post-cutoff via IGDB release date"),"post_cutoff_game";if(ke(e)||ke(a))return"post_cutoff_game";const s=Ne(e)||Ne(a);return s&&(r.includes("meta")||r.includes("tier list")||r.includes("best")||r.includes("current")||r.includes("viable")||r.includes("nerf")||r.includes("buff")||r.includes("season")||r.includes("ranked")||r.includes("competitive")||r.includes("patch"))?"live_service_meta":r.includes("latest news")||r.includes("recent news")||r.includes("gaming news")||r.includes("announced today")||r.includes("announced this week")||r.includes("just announced")||r.includes("breaking news")||r.includes("new announcement")?"current_news":r.includes("patch notes")||r.includes("latest patch")||r.includes("recent update")||r.includes("new update")||r.includes("hotfix")||r.includes("balance change")||r.includes("what changed")||r.includes("patch")&&(r.includes("today")||r.includes("latest")||r.includes("new"))?"patch_notes":r.includes("release")&&r.includes("date")||r.includes("when does")||r.includes("when is")||r.includes("coming out")||r.includes("launch date")||r.includes("coming soon")||r.includes("2025")||r.includes("2026")?"release_dates":!s&&(r.includes("how do i")||r.includes("how to")||r.includes("help me")||r.includes("stuck on")||r.includes("boss")||r.includes("strategy")||r.includes("build")||r.includes("tips")||r.includes("guide")||r.includes("walkthrough")||r.includes("where is")||r.includes("where can i")||r.includes("best way to")||r.includes("how do you")||r.includes("explain"))?"game_help":"general_knowledge"}function Ze(a,e,t,r){const s=ae[e];return a==="post_cutoff_game"?t>=s.gameKnowledge?{useGrounding:!1,reason:`Game knowledge limit reached (${t}/${s.gameKnowledge}). AI will use training knowledge.`,usageType:"game_knowledge"}:{useGrounding:!0,reason:"Game released after AI knowledge cutoff (Jan 2025) - web search required",usageType:"game_knowledge"}:r>=s.aiMessages?{useGrounding:!1,reason:`AI message limit reached (${r}/${s.aiMessages}). AI will use training knowledge.`,usageType:"ai_message"}:a==="live_service_meta"?{useGrounding:!0,reason:"Live service game - current meta/patch info requires web search",usageType:"ai_message"}:a==="current_news"?{useGrounding:!0,reason:"Current news query requires web search",usageType:"ai_message"}:a==="patch_notes"?{useGrounding:!0,reason:"Recent patch notes require web search",usageType:"ai_message"}:a==="release_dates"?{useGrounding:!0,reason:"Release date verification via web search",usageType:"ai_message"}:a==="game_help"?{useGrounding:!1,reason:"Known game - AI has comprehensive training knowledge",usageType:"ai_message"}:a==="general_knowledge"?{useGrounding:!1,reason:"General gaming knowledge - AI can answer from training",usageType:"ai_message"}:{useGrounding:!1,reason:"Default: use AI knowledge",usageType:"ai_message"}}const pe=new Map,gr=300*1e3;let J=null;function et(){const a=new Date;return`${a.getFullYear()}-${String(a.getMonth()+1).padStart(2,"0")}`}async function Ge(a){var r,s;console.log("[GroundingControl] getGroundingUsage called for:",a);const e=et(),t=pe.get(a);if(t&&t.month===e&&Date.now()-t.lastSync<gr){const o={gameKnowledge:t.gameKnowledgeCount,aiMessages:t.aiMessageCount,total:t.count};return console.log("[GroundingControl] Returning cached usage:",o),o}if(J===!1)return{gameKnowledge:(t==null?void 0:t.gameKnowledgeCount)||0,aiMessages:(t==null?void 0:t.aiMessageCount)||0,total:(t==null?void 0:t.count)||0};try{const{data:o,error:n}=await l.from("user_grounding_usage").select("usage_count, game_knowledge_count, ai_message_count").eq("auth_user_id",a).eq("month_year",e).maybeSingle();if(n)return n.code==="42P01"||n.code==="PGRST205"||(r=n.message)!=null&&r.includes("does not exist")||(s=n.message)!=null&&s.includes("Could not find")?(console.warn("[GroundingControl] DB table not yet created, using in-memory tracking"),J=!1,{gameKnowledge:(t==null?void 0:t.gameKnowledgeCount)||0,aiMessages:(t==null?void 0:t.aiMessageCount)||0,total:(t==null?void 0:t.count)||0}):(console.error("[GroundingControl] Failed to fetch usage:",n),{gameKnowledge:(t==null?void 0:t.gameKnowledgeCount)||0,aiMessages:(t==null?void 0:t.aiMessageCount)||0,total:(t==null?void 0:t.count)||0});if(J=!0,console.log("[GroundingControl] Raw data from DB:",o),!o)return console.log("[GroundingControl] No usage record found for this month - user has full quota"),{gameKnowledge:0,aiMessages:0,total:0};const i=(o==null?void 0:o.game_knowledge_count)||0,c=(o==null?void 0:o.ai_message_count)||0,u=(o==null?void 0:o.usage_count)||0;return pe.set(a,{count:u,gameKnowledgeCount:i,aiMessageCount:c,month:e,lastSync:Date.now()}),{gameKnowledge:i,aiMessages:c,total:u}}catch(o){return console.error("[GroundingControl] Error fetching usage:",o),{gameKnowledge:(t==null?void 0:t.gameKnowledgeCount)||0,aiMessages:(t==null?void 0:t.aiMessageCount)||0,total:(t==null?void 0:t.count)||0}}}async function mr(a,e="ai_message"){var s;const t=et(),r=pe.get(a);if(r&&r.month===t?(r.count++,e==="game_knowledge"?r.gameKnowledgeCount++:r.aiMessageCount++,r.lastSync=Date.now()):pe.set(a,{count:1,gameKnowledgeCount:e==="game_knowledge"?1:0,aiMessageCount:e==="ai_message"?1:0,month:t,lastSync:Date.now()}),J===!1){console.log(`🔍 [GroundingControl] Incremented ${e} usage (in-memory) for ${a} (month: ${t})`);return}try{const{error:o}=await l.rpc("increment_grounding_usage",{p_auth_user_id:a,p_month_year:t,p_usage_type:e});if(o){if(o.code==="42P01"||(s=o.message)!=null&&s.includes("does not exist")){console.warn("[GroundingControl] DB table not yet created, using in-memory tracking"),J=!1;return}await l.rpc("increment_grounding_usage",{p_auth_user_id:a,p_month_year:t})}J=!0,console.log(`🔍 [GroundingControl] Incremented usage for ${a} (month: ${t})`)}catch(o){console.error("[GroundingControl] Failed to increment usage:",o)}}async function hr(a,e){try{const t=e||"free";console.log("[GroundingControl] getRemainingQuota called with:",{authUserId:a,tier:t});const r=await Ge(a);console.log("[GroundingControl] getGroundingUsage returned:",r);const s=ae[t];return console.log("[GroundingControl] Limits for tier:",s),r?{gameKnowledge:{used:r.gameKnowledge,limit:s.gameKnowledge,remaining:Math.max(0,s.gameKnowledge-r.gameKnowledge)},aiMessages:{used:r.aiMessages,limit:s.aiMessages,remaining:Math.max(0,s.aiMessages-r.aiMessages)}}:(console.error("[GroundingControl] getGroundingUsage returned undefined"),{gameKnowledge:{used:0,limit:s.gameKnowledge,remaining:s.gameKnowledge},aiMessages:{used:0,limit:s.aiMessages,remaining:s.aiMessages}})}catch(t){console.error("[GroundingControl] Error in getRemainingQuota:",t);const s=ae[e||"free"];return{gameKnowledge:{used:0,limit:s.gameKnowledge,remaining:s.gameKnowledge},aiMessages:{used:0,limit:s.aiMessages,remaining:s.aiMessages}}}}async function pr(a,e,t,r,s){const o=Qe(t,r,s),n=await Ge(a),i=ae[e],c={gameKnowledge:{used:n.gameKnowledge,limit:i.gameKnowledge,remaining:Math.max(0,i.gameKnowledge-n.gameKnowledge)},aiMessages:{used:n.aiMessages,limit:i.aiMessages,remaining:Math.max(0,i.aiMessages-n.aiMessages)}},{useGrounding:u,reason:f,usageType:E}=Ze(o,e,n.gameKnowledge,n.aiMessages);return console.log("🔍 [GroundingControl] Check result:",{tier:e,queryType:o,useGrounding:u,usageType:E,reason:f,usage:{gameKnowledge:`${n.gameKnowledge}/${i.gameKnowledge}`,aiMessages:`${n.aiMessages}/${i.aiMessages}`},remainingQuota:c,igdbReleaseDate:s?new Date(s*1e3).toISOString():"N/A"}),{useGrounding:u,queryType:o,reason:f,usageType:E,remainingQuota:c}}const ps={classifyQuery:Qe,shouldUseGrounding:Ze,getGroundingUsage:Ge,incrementGroundingUsage:mr,getRemainingQuota:hr,checkGroundingEligibility:pr,isLiveServiceGame:Ne,isPostCutoffGame:ke,isRecentRelease:Xe,GROUNDING_LIMITS:ae,LIVE_SERVICE_GAMES:Ce,POST_CUTOFF_GAMES:Ie,KNOWLEDGE_CUTOFF_TIMESTAMP:Je},fr={light:10,medium:20,heavy:40,success:[10,50,10],error:[50,100,50],warning:[20,50,20,50,20],buttonPress:15,modalOpen:[10,30,10],modalClose:10,tabSwitch:12,messageSend:[10,40,15],swipe:8,longPress:[0,50,30],notification:[20,100,20,100,30]};function tt(){return typeof navigator<"u"&&"vibrate"in navigator&&typeof navigator.vibrate=="function"}function rt(){return Tt()&&tt()}function _(a){var e;if(!rt())return!1;try{const t=fr[a];return(e=navigator.vibrate)==null||e.call(navigator,t),!0}catch(t){return console.warn("[Haptic] Failed to trigger haptic feedback:",t),!1}}function yr(){var a;tt()&&((a=navigator.vibrate)==null||a.call(navigator,0))}const fs={light:()=>_("light"),medium:()=>_("medium"),heavy:()=>_("heavy"),success:()=>_("success"),error:()=>_("error"),warning:()=>_("warning"),button:()=>_("buttonPress"),modalOpen:()=>_("modalOpen"),modalClose:()=>_("modalClose"),tabSwitch:()=>_("tabSwitch"),messageSend:()=>_("messageSend"),swipe:()=>_("swipe"),longPress:()=>_("longPress"),notification:()=>_("notification"),stop:yr,isAvailable:rt};class Sr{constructor(){b(this,"STORAGE_KEY","otakon_used_suggested_prompts");b(this,"LAST_RESET_KEY","otakon_suggested_prompts_last_reset");b(this,"RESET_INTERVAL_MS",1440*60*1e3);b(this,"usedPrompts",new Set);this.loadUsedPrompts(),this.checkAndResetIfNeeded()}loadUsedPrompts(){try{const e=localStorage.getItem(this.STORAGE_KEY);if(e){const t=JSON.parse(e);this.usedPrompts=new Set(t)}}catch{this.usedPrompts=new Set}}saveUsedPrompts(){try{const e=Array.from(this.usedPrompts);localStorage.setItem(this.STORAGE_KEY,JSON.stringify(e))}catch{}}checkAndResetIfNeeded(){try{const e=localStorage.getItem(this.LAST_RESET_KEY),t=Date.now();(!e||t-parseInt(e)>=this.RESET_INTERVAL_MS)&&(this.resetUsedPrompts(),localStorage.setItem(this.LAST_RESET_KEY,t.toString()))}catch{}}markPromptAsUsed(e){this.usedPrompts.add(e),this.saveUsedPrompts()}isPromptUsed(e){return this.usedPrompts.has(e)}getUnusedPrompts(e){return e.filter(t=>!this.isPromptUsed(t))}areAllPromptsUsed(e){return e.every(t=>this.isPromptUsed(t))}resetUsedPrompts(){this.usedPrompts.clear(),localStorage.removeItem(this.STORAGE_KEY)}getUsedCount(){return this.usedPrompts.size}getTimeUntilNextReset(){try{const e=localStorage.getItem(this.LAST_RESET_KEY);if(!e)return 0;const t=parseInt(e)+this.RESET_INTERVAL_MS;return Math.max(0,t-Date.now())}catch{return 0}}getStaticNewsPrompts(){return ft}processAISuggestions(e){if(console.log("🔧 [SuggestedPromptsService] processAISuggestions INPUT:",e),console.log("🔧 [SuggestedPromptsService] INPUT type:",typeof e),console.log("🔧 [SuggestedPromptsService] INPUT is Array:",Array.isArray(e)),console.log("🔧 [SuggestedPromptsService] INPUT JSON:",JSON.stringify(e)),!e)return console.log("🔧 [SuggestedPromptsService] No suggestions - returning []"),[];if(Array.isArray(e)&&e.length===0)return console.log("🔧 [SuggestedPromptsService] Empty array - returning []"),[];let t=[];if(Array.isArray(e))console.log("🔧 [SuggestedPromptsService] Input is array, checking elements..."),t=e.flat().filter(s=>{const o=typeof s=="string"&&s.trim().length>0;return!o&&s!==null&&s!==void 0&&console.log("🔧 [SuggestedPromptsService] Filtering out non-string item:",s,typeof s),o}),console.log("🔧 [SuggestedPromptsService] Array after filtering:",t);else if(typeof e=="string"){let s=e.trim();s.startsWith('["')&&!s.endsWith('"]')&&(s.endsWith('"')||(s+='"'),s.endsWith("]")||(s+="]"));try{const o=JSON.parse(s);Array.isArray(o)?t=o:t=[e]}catch{s.includes('", "')||s.includes(`",
"`)?t=s.split(/",\s*"/).map(n=>n.replace(/^["\s]+|["\s]+$/g,"")).filter(n=>n.length>0):s.includes(`
`)?t=s.split(`
`).map(n=>n.replace(/^["\s]+|["\s]+$/g,"")).filter(n=>n.length>0):t=[e]}}const r=t.filter(s=>s&&typeof s=="string"&&s.trim().length>0).map(s=>s.trim()).slice(0,3);return console.log("🔧 [SuggestedPromptsService] suggestionsArray before filter:",t),console.log("🔧 [SuggestedPromptsService] RESULT after filter/map/slice:",r),console.log("🔧 [SuggestedPromptsService] RESULT length:",r.length),r}getFallbackSuggestions(e,t){return t===!0||e==="game-hub"||e==="everything-else"?this.getStaticNewsPrompts():["What should I do next in this area?","Tell me about the story so far","Give me some tips for this game","What are the key mechanics I should know?"]}}const ys=new Sr,oe=new Map,br=300*1e3;function Tr(a,e,t){return`${a}:${e}:${t||"global"}`}function Er(a){const e=oe.get(a);return e?Date.now()-e.timestamp>br?(oe.delete(a),null):e.prompts:null}function wr(a,e){oe.set(a,{prompts:e,timestamp:Date.now()})}function st(a){for(const e of oe.keys())e.startsWith(a)&&oe.delete(e)}async function De(a,e,t=null,r=20){const s=Tr(a,e,t),o=Er(s);if(o)return o;try{const n=new Date;n.setDate(n.getDate()-7);let i=l.from("ai_shown_prompts").select("prompt_text").eq("auth_user_id",a).eq("prompt_type",e).gte("shown_at",n.toISOString()).order("shown_at",{ascending:!1}).limit(r);t&&(i=i.or(`game_title.eq.${t},game_title.is.null`));const{data:c,error:u}=await i;if(u)return console.error("[ShownPromptsService] Error fetching prompts:",u),[];const f=(c||[]).map(E=>E.prompt_text);return wr(s,f),f}catch(n){return console.error("[ShownPromptsService] Exception fetching prompts:",n),[]}}async function _r(a,e){try{const{error:t}=await l.from("ai_shown_prompts").insert({auth_user_id:a,prompt_text:e.promptText,prompt_type:e.promptType,game_title:e.gameTitle||null,conversation_id:e.conversationId||null});return t?(console.error("[ShownPromptsService] Error recording prompt:",t),!1):(st(a),!0)}catch(t){return console.error("[ShownPromptsService] Exception recording prompt:",t),!1}}async function Ar(a,e){if(!e.length)return!0;try{const t=e.map(s=>({auth_user_id:a,prompt_text:s.promptText,prompt_type:s.promptType,game_title:s.gameTitle||null,conversation_id:s.conversationId||null})),{error:r}=await l.from("ai_shown_prompts").insert(t);return r?(console.error("[ShownPromptsService] Error batch recording prompts:",r),!1):(st(a),!0)}catch(t){return console.error("[ShownPromptsService] Exception batch recording prompts:",t),!1}}async function Or(a,e){try{const{error:t}=await l.from("ai_shown_prompts").update({clicked:!0,clicked_at:new Date().toISOString()}).eq("auth_user_id",a).eq("prompt_text",e).is("clicked",!1);return t?(console.error("[ShownPromptsService] Error marking prompt clicked:",t),!1):!0}catch(t){return console.error("[ShownPromptsService] Exception marking prompt clicked:",t),!1}}async function vr(a,e,t,r=null){if(!e.length)return[];const s=await De(a,t,r),o=new Set(s.map(n=>n.toLowerCase().trim()));return e.filter(n=>!o.has(n.toLowerCase().trim()))}async function Cr(a,e,t,r=null){const s=await De(a,t,r),o=e.toLowerCase().trim();return s.some(n=>n.toLowerCase().trim()===o)}const Ss={getRecentShownPrompts:De,recordShownPrompt:_r,recordShownPrompts:Ar,markPromptClicked:Or,filterNewPrompts:vr,hasPromptBeenShown:Cr},V=class V{static getInstance(){return V.instance||(V.instance=new V),V.instance}async getSubtabs(e){return this.getSubtabsFromTable(e)}async setSubtabs(e,t,r=!1){console.error(`🔄 [SubtabsService] ${r?"Updating":"Creating"} ${t.length} subtabs in normalized table for conversation:`,e);const o=await this.setSubtabsInTable(e,t);return console.error("  ✅ Table write:",o?"SUCCESS":"FAILED"),o}async addSubtab(e,t){const{data:r,error:s}=await l.from("conversations").select("is_unreleased, title").eq("id",e).single();if(s)return console.error("Error checking conversation for unreleased status:",s),null;if(r!=null&&r.is_unreleased)throw new Error("Subtabs cannot be created for unreleased games. This feature will be available once the game is released.");return await this.addSubtabToTable(e,t)}async updateSubtab(e,t,r){return await this.updateSubtabInTable(t,r)}async deleteSubtab(e,t){return this.deleteSubtabFromTable(t)}async getSubtabsFromTable(e){try{const{data:t,error:r}=await l.from("subtabs").select("*").eq("conversation_id",e).order("order_index",{ascending:!0});return r?(console.error("Error getting subtabs from table:",r),[]):(t||[]).map(s=>{const o=typeof s.metadata=="object"&&s.metadata!==null?s.metadata:{};return{id:s.id,conversationId:s.conversation_id??void 0,title:s.title,content:s.content||"",type:s.tab_type,isNew:o.isNew||!1,status:o.status||"loaded",instruction:o.instruction}})}catch(t){return console.error("Error getting subtabs from table:",t),[]}}async setSubtabsInTable(e,t){try{const{data:r,error:s}=await l.from("conversations").select("*").eq("id",e).single(),o=r==null?void 0:r.auth_user_id;if(s||!o)return console.error("❌ [SubtabsService] Error getting conversation auth_user_id:",s),console.error("❌ [SubtabsService] Conversation may not exist yet. ConversationId:",e),!1;console.error(`🔄 [SubtabsService] Using auth_user_id: ${o} for ${t.length} subtabs`);const{error:n}=await l.from("subtabs").delete().eq("conversation_id",e);if(n)return console.error("Error deleting existing subtabs:",n),!1;if(t.length>0){const i=t.map((u,f)=>(u.type||console.error(`⚠️ [SubtabsService] Subtab "${u.title}" has NULL type! Using fallback.`),{id:u.id,conversation_id:e,game_id:null,title:u.title||"Untitled",content:u.content||"",tab_type:u.type||"chat",order_index:f,auth_user_id:o,metadata:{isNew:u.isNew,status:u.status,instruction:u.instruction}}));console.error("🔄 [SubtabsService] Inserting subtabs:",i.map(u=>({title:u.title,tab_type:u.tab_type,has_auth_user_id:!!u.auth_user_id})));const{error:c}=await l.from("subtabs").insert(i);if(c)return console.error("❌ [SubtabsService] Error inserting subtabs:",c),console.error("❌ [SubtabsService] Failed subtabs data:",JSON.stringify(i,null,2)),!1;console.error("✅ [SubtabsService] Successfully inserted",t.length,"subtabs")}return!0}catch(r){return console.error("❌ [SubtabsService] Error setting subtabs in table:",r),!1}}async addSubtabToTable(e,t){var r;try{const{data:s}=await l.from("conversations").select("game_id").eq("id",e).single(),o=(s==null?void 0:s.game_id)||"",{data:n}=await l.from("subtabs").select("order_index").eq("conversation_id",e).order("order_index",{ascending:!1}).limit(1),i=((r=n==null?void 0:n[0])==null?void 0:r.order_index)??-1,{data:c,error:u}=await l.from("subtabs").insert({id:t.id,conversation_id:e,game_id:o,title:t.title,content:t.content,tab_type:t.type,order_index:i+1,metadata:{isNew:t.isNew,status:t.status,instruction:t.instruction}}).select().single();return u?(console.error("Error adding subtab to table:",u),null):{id:c.id,conversationId:c.conversation_id??void 0,title:c.title,content:yt(c.content),type:c.tab_type,isNew:typeof c.metadata=="object"&&c.metadata!==null&&!Array.isArray(c.metadata)&&c.metadata.isNew||!1,status:(typeof c.metadata=="object"&&c.metadata!==null&&!Array.isArray(c.metadata)?c.metadata.status:void 0)||"loaded",instruction:typeof c.metadata=="object"&&c.metadata!==null&&!Array.isArray(c.metadata)?c.metadata.instruction:void 0}}catch(s){return console.error("Error adding subtab to table:",s),null}}async updateSubtabInTable(e,t){try{const r={};if(t.title!==void 0&&(r.title=t.title),t.content!==void 0&&(r.content=t.content),t.type!==void 0&&(r.tab_type=t.type),t.isNew!==void 0||t.status!==void 0||t.instruction!==void 0){const{data:o}=await l.from("subtabs").select("metadata").eq("id",e).single(),n=typeof(o==null?void 0:o.metadata)=="object"&&(o==null?void 0:o.metadata)!==null?o.metadata:{};r.metadata={...n,...t.isNew!==void 0&&{isNew:t.isNew},...t.status!==void 0&&{status:t.status},...t.instruction!==void 0&&{instruction:t.instruction}}}const{error:s}=await l.from("subtabs").update(r).eq("id",e);return s?(console.error("Error updating subtab in table:",s),!1):!0}catch(r){return console.error("Error updating subtab in table:",r),!1}}async deleteSubtabFromTable(e){try{const{error:t}=await l.from("subtabs").delete().eq("id",e);return t?(console.error("Error deleting subtab from table:",t),!1):!0}catch(t){return console.error("Error deleting subtab from table:",t),!1}}async getSubtabsFromJsonb(e){try{const{data:t,error:r}=await l.from("conversations").select("subtabs").eq("id",e).single();return r?(console.error("Error getting subtabs from JSONB:",r),[]):(t==null?void 0:t.subtabs)||[]}catch(t){return console.error("Error getting subtabs from JSONB:",t),[]}}async setSubtabsInJsonb(e,t){try{const{error:r}=await l.from("conversations").update({subtabs:t,subtabs_order:t.map(s=>s.id)}).eq("id",e);return r?(console.error("Error setting subtabs in JSONB:",r),!1):!0}catch(r){return console.error("Error setting subtabs in JSONB:",r),!1}}async migrateConversationSubtabs(e){try{const t=await this.getSubtabsFromJsonb(e);return t.length===0?!0:await this.setSubtabsInTable(e,t)}catch(t){return console.error("Error migrating subtabs:",t),!1}}async rollbackConversationSubtabs(e){try{const t=await this.getSubtabsFromTable(e);return t.length===0?!0:await this.setSubtabsInJsonb(e,t)}catch(t){return console.error("Error rolling back subtabs:",t),!1}}async migrateAllSubtabs(){try{const{data:e,error:t}=await l.from("conversations").select("id, subtabs").not("subtabs","is",null);if(t)return console.error("Error fetching conversations:",t),{success:0,failed:0};let r=0,s=0;const o=(e||[]).filter(i=>i.subtabs&&Array.isArray(i.subtabs)&&i.subtabs.length>0).map(i=>this.migrateConversationSubtabs(i.id));return(await Promise.allSettled(o)).forEach(i=>{i.status==="fulfilled"&&i.value?r++:s++}),{success:r,failed:s}}catch(e){return console.error("Error in batch migration:",e),{success:0,failed:0}}}};b(V,"instance");let Re=V;const bs=Re.getInstance(),Be={free:3,pro:10,vanguard_pro:10},Ts={async canCreateUnreleasedTab(a,e){const t=Be[e]||Be.free,{count:r,error:s}=await l.from("unreleased_game_tabs").select("*",{count:"exact",head:!0}).eq("user_id",a);if(s)return console.error("[UnreleasedTabLimit] Error counting tabs:",s),{canCreate:!0,currentCount:0,limit:t};const o=r||0;return{canCreate:o<t,currentCount:o,limit:t}},async trackUnreleasedTab(a,e,t,r){const{error:s}=await l.from("unreleased_game_tabs").insert({user_id:a,conversation_id:e,game_id:t,game_title:r});return s?(console.error("[UnreleasedTabLimit] Error tracking tab:",s),!1):!0},async untrackUnreleasedTab(a){const{error:e}=await l.from("unreleased_game_tabs").delete().eq("conversation_id",a);return e?(console.error("[UnreleasedTabLimit] Error untracking tab:",e),!1):!0},async getUserUnreleasedTabs(a){const{data:e,error:t}=await l.from("unreleased_game_tabs").select("conversation_id, game_title, created_at").eq("user_id",a).order("created_at",{ascending:!1});return t?(console.error("[UnreleasedTabLimit] Error getting tabs:",t),[]):(e||[]).map(r=>({conversationId:r.conversation_id,gameTitle:r.game_title,createdAt:r.created_at}))}},H=a=>a;class Es{static getCurrentUser(){return W.get($.USER,null)}static setCurrentUser(e){W.set($.USER,e)}static createUser(e,t=St.FREE){const r=Date.now(),s=Le[t];return{id:`user_${r}`,authUserId:`user_${r}`,email:e,tier:t,hasProfileSetup:!1,hasSeenSplashScreens:!1,hasSeenHowToUse:!1,hasSeenFeaturesConnected:!1,hasSeenProFeatures:!1,hasSeenWelcomeGuide:!1,pcConnected:!1,pcConnectionSkipped:!1,onboardingCompleted:!1,hasWelcomeMessage:!1,isNewUser:!0,hasUsedTrial:!1,lastActivity:r,preferences:{},textCount:0,imageCount:0,textLimit:s.text,imageLimit:s.image,totalRequests:0,lastReset:r,usage:{textCount:0,imageCount:0,textLimit:s.text,imageLimit:s.image,totalRequests:0,lastReset:r,tier:t},appState:{},profileData:{},onboardingData:{},behaviorData:{},feedbackData:{},usageData:{},createdAt:r,updatedAt:r}}static updateUser(e){const t=this.getCurrentUser();if(!t)return;const r={...t,...e,updatedAt:Date.now()};this.setCurrentUser(r)}static updateUsage(e){const t=this.getCurrentUser();t&&this.updateUser({usage:{...t.usage,...e}})}static resetUsage(){const e=this.getCurrentUser();if(!e)return;const t=Le[e.tier];this.updateUsage({textCount:0,imageCount:0,totalRequests:0,lastReset:Date.now(),textLimit:t.text,imageLimit:t.image})}static canMakeRequest(e){const t=this.getCurrentUser();if(!t)return!1;if(t.usesCustomGeminiKey)return!0;const{usage:r}=t;return e==="text"?r.textCount<r.textLimit:r.imageCount<r.imageLimit}static incrementUsage(e){const t=this.getCurrentUser();if(!t)return;const r={totalRequests:t.usage.totalRequests+1};e==="text"?r.textCount=t.usage.textCount+1:r.imageCount=t.usage.imageCount+1,this.updateUsage(r)}static logout(){W.remove($.USER)}static async getCurrentUserAsync(){try{const e=W.get($.USER,null),{data:{user:t},error:r}=await l.auth.getUser();if(r||!t)return e;const{data:s,error:o}=await l.from("users").select("*").eq("auth_user_id",t.id).single();if(o||!s)return console.error("Failed to fetch user from Supabase:",o),e;const n={id:s.id,authUserId:s.auth_user_id,email:s.email,tier:s.tier,textCount:s.text_count||0,imageCount:s.image_count||0,textLimit:ie(s.text_limit),imageLimit:ie(s.image_limit),totalRequests:s.total_requests||0,lastReset:Z(s.last_reset),hasProfileSetup:s.has_profile_setup||!1,hasSeenSplashScreens:s.has_seen_splash_screens||!1,hasSeenHowToUse:s.has_seen_how_to_use||!1,hasSeenFeaturesConnected:s.has_seen_features_connected||!1,hasSeenProFeatures:s.has_seen_pro_features||!1,hasSeenWelcomeGuide:s.has_seen_welcome_guide||!1,pcConnected:s.pc_connected||!1,pcConnectionSkipped:s.pc_connection_skipped||!1,onboardingCompleted:s.onboarding_completed||!1,hasWelcomeMessage:s.has_welcome_message||!1,isNewUser:s.is_new_user||!1,hasUsedTrial:s.has_used_trial||!1,lastActivity:Z(s.updated_at),preferences:K(s.preferences),usage:{textCount:s.text_count||0,imageCount:s.image_count||0,textLimit:ie(s.text_limit),imageLimit:ie(s.image_limit),totalRequests:s.total_requests||0,lastReset:Z(s.last_reset),tier:s.tier},appState:K(s.app_state),profileData:K(s.profile_data),onboardingData:K(s.onboarding_data),behaviorData:K(s.behavior_data),feedbackData:K(s.feedback_data),usageData:K(s.usage_data),createdAt:Z(s.created_at),updatedAt:Z(s.updated_at)};return W.set($.USER,n),console.log("🔍 [UserService] Loaded user from database:",{email:n.email,hasSeenWelcomeGuide:n.hasSeenWelcomeGuide,authUserId:n.authUserId}),n}catch(e){return console.error("Error in getCurrentUserAsync:",e),W.get($.USER,null)}}static async setCurrentUserAsync(e){var t;try{console.log("🔍 [UserService] setCurrentUserAsync called with hasSeenWelcomeGuide:",e.hasSeenWelcomeGuide),W.set($.USER,e),e.authUserId&&(await Et.setUser(e.authUserId,e),console.log("✅ [UserService] Updated cache for user:",e.authUserId));const{data:r,error:s,count:o}=await l.from("users").update({tier:e.tier,text_count:e.textCount,image_count:e.imageCount,text_limit:e.textLimit,image_limit:e.imageLimit,total_requests:e.totalRequests,last_reset:new Date(e.lastReset).toISOString(),has_profile_setup:e.hasProfileSetup,has_seen_splash_screens:e.hasSeenSplashScreens,has_seen_how_to_use:e.hasSeenHowToUse,has_seen_features_connected:e.hasSeenFeaturesConnected,has_seen_pro_features:e.hasSeenProFeatures,has_seen_welcome_guide:e.hasSeenWelcomeGuide,pc_connected:e.pcConnected,pc_connection_skipped:e.pcConnectionSkipped,onboarding_completed:e.onboardingCompleted,has_welcome_message:e.hasWelcomeMessage,has_used_trial:e.hasUsedTrial,preferences:H(e.preferences),profile_data:H(e.profileData),app_state:H(e.appState),onboarding_data:H(e.onboardingData),behavior_data:H(e.behaviorData),feedback_data:H(e.feedbackData),usage_data:H(e.usageData),updated_at:new Date().toISOString()}).eq("auth_user_id",e.authUserId).select();s?(console.error("❌ [UserService] Failed to sync user to Supabase:",s),console.error("❌ [UserService] Error details:",{message:s.message,code:s.code,details:s.details,hint:s.hint})):!r||r.length===0?(console.error("❌ [UserService] Database update succeeded but 0 rows affected!",{authUserId:e.authUserId,hasSeenWelcomeGuide:e.hasSeenWelcomeGuide,returnedData:r,count:o}),console.error("❌ [UserService] This indicates RLS policy is blocking the update silently!")):(console.log("✅ [UserService] Successfully updated database for user:",e.authUserId),console.log("✅ [UserService] Verified has_seen_welcome_guide in DB:",(t=r[0])==null?void 0:t.has_seen_welcome_guide))}catch(r){console.error("Error in setCurrentUserAsync:",r)}}static async updateUsageAsync(e){const t=await this.getCurrentUserAsync();if(!t)return;const r={...t,usage:{...t.usage,...e},textCount:e.textCount??t.textCount,imageCount:e.imageCount??t.imageCount,totalRequests:e.totalRequests??t.totalRequests,lastReset:e.lastReset??t.lastReset,updatedAt:Date.now()};await this.setCurrentUserAsync(r)}}class Ir{hasTabCommand(e){return/^@\w+/.test(e.trim())}parseTabCommand(e,t){const r=e.trim();if(!this.hasTabCommand(r))return null;const s=r.match(/^@(\w+)\s*(\\modify|\\delete)?\s*(.*)$/);if(!s)return null;const[,o,n,i]=s,c=this.findMatchingTab(o,t.subtabs||[]);if(!c)return null;let u;return n==="\\delete"?u="delete":n==="\\modify"?u="modify":u="update",{type:u,tabId:c.id,tabName:c.title,instruction:i.trim()}}findMatchingTab(e,t){const r=this.normalizeTabName(e);let s=t.find(o=>this.normalizeTabName(o.id)===r||this.normalizeTabName(o.title)===r);return s||(s=t.find(o=>this.normalizeTabName(o.id).includes(r)||this.normalizeTabName(o.title).includes(r)),s)?s:(s=t.find(o=>r.includes(this.normalizeTabName(o.id))||r.includes(this.normalizeTabName(o.title))),s||null)}normalizeTabName(e){return e.toLowerCase().replace(/[_\s-]+/g,"").replace(/[^a-z0-9]/g,"")}getAvailableTabNames(e){return!e.subtabs||e.subtabs.length===0?[]:e.subtabs.map(t=>({id:t.id,title:t.title}))}formatTabSuggestion(e,t){return`@${e}`}getCommandHelp(){return`
**Tab Commands:**
...
Example: @story_so_far The player defeated the first boss
    `.trim()}validateCommand(e){switch(e.type){case"update":if(!e.instruction)return{valid:!1,error:"Update command requires content. Example: @story_so_far The player..."};break;case"modify":if(!e.instruction)return{valid:!1,error:"Modify command requires instructions. Example: @tips \\modify Change to combat strategies"};break}return{valid:!0}}describeCommand(e){switch(e.type){case"update":return`Updating "${e.tabName}" with: ${e.instruction}`;case"modify":return`Modifying "${e.tabName}": ${e.instruction}`;case"delete":return`Deleting "${e.tabName}"`}}}const ws=new Ir;let g,j=[],He=!1,X="",L=null,M=null,v=null,F=null;const Nr="otakonSpeechRate",Me=async()=>{try{const a=navigator;if(a.wakeLock){if(L!==null)try{await L.release()}catch{}L=await a.wakeLock.request("screen"),console.log("🔒 [TTS] Wake lock acquired - screen will stay on"),L.addEventListener("release",async()=>{console.log("🔓 [TTS] Wake lock released"),L=null,g&&g.speaking&&(console.log("🔒 [TTS] Reacquiring wake lock (TTS still active)"),await Me())})}else console.warn("⚠️ [TTS] Wake lock API not available")}catch(a){console.warn("⚠️ [TTS] Wake lock request failed:",a)}},at=async()=>{try{L!==null&&(await L.release(),L=null)}catch{}},kr=()=>{try{if(!M){const a=window,e=a.AudioContext||a.webkitAudioContext;e&&(M=new e,console.log("🔊 [TTS] Audio context initialized"))}v||(v=new Audio,v.src="data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2teleShtr9teleShtr9teleShtr9teleShtr9t",v.loop=!0,v.volume=.01,v.load(),console.log("🔇 [TTS] Silent audio initialized for background playback"))}catch(a){console.warn("⚠️ [TTS] Audio context init failed:",a)}},ot=async()=>{try{M&&M.state==="suspended"&&(await M.resume(),console.log("🔊 [TTS] Audio context resumed")),v&&(v.currentTime=0,await v.play(),console.log("🔇 [TTS] Silent audio playing for background session")),F||(F=setInterval(()=>{g&&g.speaking?M&&M.state==="suspended"&&M.resume().catch(()=>{}):F&&(clearInterval(F),F=null)},5e3))}catch(a){console.warn("⚠️ [TTS] Silent audio start failed:",a)}},nt=()=>{try{v&&(v.pause(),v.currentTime=0,console.log("🔇 [TTS] Silent audio stopped")),F&&(clearInterval(F),F=null)}catch(a){console.warn("⚠️ [TTS] Silent audio stop failed:",a)}},Rr=()=>new Promise((a,e)=>{if(!g)return e(new Error("Speech synthesis not initialized."));if(j=g.getVoices(),j.length>0){a();return}g.onvoiceschanged=()=>{j=g.getVoices(),a()},setTimeout(()=>{j.length===0&&(j=g.getVoices()),a()},1e3)}),ne=()=>{g&&g.speaking&&g.cancel(),X="","mediaSession"in navigator&&navigator.mediaSession.playbackState!=="none"&&(navigator.mediaSession.playbackState="paused"),at(),nt(),window.dispatchEvent(new CustomEvent("otakon:ttsStopped"))},it=()=>{g&&g.speaking&&!g.paused&&(g.pause(),"mediaSession"in navigator&&(navigator.mediaSession.playbackState="paused"),window.dispatchEvent(new CustomEvent("otakon:ttsPaused")))},ct=()=>{g&&g.paused&&(g.resume(),"mediaSession"in navigator&&(navigator.mediaSession.playbackState="playing"),window.dispatchEvent(new CustomEvent("otakon:ttsResumed")))},Pr=async()=>{X&&(ne(),await ut(X))},Ur=()=>g?g.speaking:!1,Gr=()=>{ne(),window.dispatchEvent(new CustomEvent("otakon:disableHandsFree"))},Dr=()=>{if("mediaSession"in navigator){console.log("🎵 [TTS] Setting up media session");try{navigator.mediaSession.setActionHandler("play",()=>{console.log("🎵 [TTS] Media session play action"),g&&g.paused&&ct()}),navigator.mediaSession.setActionHandler("pause",()=>{console.log("🎵 [TTS] Media session pause action"),g&&g.speaking&&!g.paused&&it()}),navigator.mediaSession.setActionHandler("stop",()=>{console.log("🎵 [TTS] Media session stop action"),Gr()}),console.log("✅ [TTS] Media session handlers registered")}catch(a){console.warn("⚠️ [TTS] Failed to set media session handlers:",a)}}else console.warn("⚠️ [TTS] Media session API not available")},Mr=async()=>{document.hidden?(console.log("📱 [TTS] App went to background, isSpeaking:",g==null?void 0:g.speaking),g&&g.speaking&&(await ot(),g.paused||setTimeout(()=>{g&&g.speaking&&!g.paused&&console.log("📱 [TTS] Nudging speech synthesis to stay alive")},100))):(console.log("📱 [TTS] App came to foreground, isSpeaking:",g==null?void 0:g.speaking),g&&g.speaking&&await Me())},Lr=async()=>{if(typeof window<"u"&&"speechSynthesis"in window){if(He)return;He=!0,g=window.speechSynthesis,await Rr(),Dr(),kr(),document.addEventListener("visibilitychange",Mr),g.getVoices().length===0&&g.speak(new SpeechSynthesisUtterance(""))}},lt=()=>j.filter(a=>a.lang.startsWith("en-")),ut=async a=>new Promise((e,t)=>{try{if(!g)return console.error("Text-to-Speech is not available on this browser."),t(new Error("Text-to-Speech is not available on this browser."));if(!a.trim())return e();ne(),X=a;const r=new SpeechSynthesisUtterance(a),s=localStorage.getItem(Nr);r.rate=s?parseFloat(s):.94;const o=localStorage.getItem("otakonPreferredVoiceURI"),n=lt();let i;if(o&&(i=n.find(c=>c.voiceURI===o)),!i&&n.length>0){const c=n.find(u=>u.name.toLowerCase().includes("female"));c?i=c:i=n[0]}i&&(r.voice=i),r.onstart=async()=>{if(console.log("🎤 [TTS] Speech started"),X=a,await Me(),await ot(),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.controller.postMessage({type:"TTS_STARTED"}),"mediaSession"in navigator)try{navigator.mediaSession.playbackState="playing";const c=a.replace(/[*_~`#]/g,"").replace(/\n+/g," ").trim(),u=c.length>100?c.substring(0,97)+"...":c;navigator.mediaSession.metadata=new MediaMetadata({title:u,artist:"Otagon AI",album:"Gaming Companion",artwork:[{src:"/icon-192.png",sizes:"192x192",type:"image/png"},{src:"/icon-512.png",sizes:"512x512",type:"image/png"}]}),console.log("🎵 [TTS] Media session metadata set")}catch(c){console.warn("⚠️ [TTS] Failed to set media session:",c)}window.dispatchEvent(new CustomEvent("otakon:ttsStarted"))},r.onend=()=>{X="","mediaSession"in navigator&&(navigator.mediaSession.playbackState="paused"),"serviceWorker"in navigator&&navigator.serviceWorker.controller&&navigator.serviceWorker.controller.postMessage({type:"TTS_STOPPED"}),at(),nt(),window.dispatchEvent(new CustomEvent("otakon:ttsStopped")),e()},r.onerror=c=>{console.error("SpeechSynthesis Utterance Error",c),ne(),t(c)},g.speak(r)}catch(r){console.error("TTS Error:",r),t(r)}}),_s={init:Lr,getAvailableVoices:lt,speak:ut,cancel:ne,pause:it,resume:ct,restart:Pr,isSpeaking:Ur};class Fr{constructor(){b(this,"cache",new Map);b(this,"lastFetch",new Map);b(this,"CACHE_TTL_MS",3e4)}get(e){const t=this.cache.get(e),r=this.lastFetch.get(e);return!t||!r?null:Date.now()-r>this.CACHE_TTL_MS?(this.cache.delete(e),this.lastFetch.delete(e),null):t}set(e,t){this.cache.set(e,t),this.lastFetch.set(e,Date.now())}invalidate(e){this.cache.delete(e),this.lastFetch.delete(e)}clear(){this.cache.clear(),this.lastFetch.clear()}}const As=new Fr;class ue{static async trackKeyAdded(e,t,r){try{await l.from("user_analytics").insert({user_id:e.id,auth_user_id:e.authUserId,event_type:"byok_key_added",event_data:{provider:t,tier:e.tier,...r,timestamp:new Date().toISOString()}})}catch(s){console.error("[BYOKAnalytics] Error tracking key_added:",s)}}static async trackKeyRemoved(e,t,r){try{await l.from("user_analytics").insert({user_id:e.id,auth_user_id:e.authUserId,event_type:"byok_key_removed",event_data:{provider:t,reason:r,timestamp:new Date().toISOString()}})}catch(s){console.error("[BYOKAnalytics] Error tracking key_removed:",s)}}static async trackKeyVerification(e,t,r,s){try{await l.from("user_analytics").insert({user_id:e.id,auth_user_id:e.authUserId,event_type:"byok_key_verified",event_data:{provider:t,success:r,error:s,timestamp:new Date().toISOString()}})}catch(o){console.error("[BYOKAnalytics] Error tracking key_verified:",o)}}static async trackBYOKRequest(e,t,r,s,o,n){try{await l.from("user_analytics").insert({user_id:e,auth_user_id:t,event_type:"byok_request_made",event_data:{provider:r,model:s,tokensUsed:o,requestType:n,timestamp:new Date().toISOString()}})}catch(i){console.error("[BYOKAnalytics] Error tracking byok_request:",i)}}static async getBYOKStats(e){try{const{data:t}=await l.from("user_analytics").select("event_data, created_at").eq("user_id",e).eq("event_type","byok_request_made").order("created_at",{ascending:!1}),r=(t==null?void 0:t.length)||0,s=(t==null?void 0:t.reduce((i,c)=>{const u=c.event_data;return i+(u.tokensUsed||0)},0))||0,o=[...new Set((t==null?void 0:t.map(i=>i.event_data.provider))||[])],n=t&&t.length>0?t[0].created_at:null;return{totalRequests:r,totalTokens:s,providers:o,lastUsed:n}}catch(t){return console.error("[BYOKAnalytics] Error getting BYOK stats:",t),{totalRequests:0,totalTokens:0,providers:[],lastUsed:null}}}}class Os{static async testGeminiKey(e){var t;try{const r=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent?key=${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:"test"}]}]})});if(r.ok)return{valid:!0};{const s=await r.text();console.error("[ApiKeyService] API key test failed:",s);let o="Invalid API key";try{const n=JSON.parse(s);(t=n.error)!=null&&t.message&&(o=n.error.message)}catch{r.status===400?o="Invalid API key format or request":r.status===403?o="API key denied - check permissions":r.status===404&&(o="API endpoint not found - key may be invalid")}return{valid:!1,error:o}}}catch(r){return console.error("[ApiKeyService] Error testing API key:",r),{valid:!1,error:"Failed to test API key"}}}static async saveGeminiKey(e,t){try{if(!t.startsWith("AIzaSy"))throw new Error('Invalid API key format. Gemini API keys start with "AIzaSy"');R.info("Testing your API key...");const r=await this.testGeminiKey(t);if(!r.valid)throw await ue.trackKeyVerification(e,"google",!1,r.error),new Error(r.error||"Invalid API key");const{error:s}=await l.from("users").update({gemini_api_key_encrypted:t,uses_custom_gemini_key:!0,custom_key_verified_at:new Date().toISOString(),had_custom_key_before:!0,updated_at:new Date().toISOString()}).eq("auth_user_id",e.authUserId);if(s)throw console.error("[ApiKeyService] Error saving API key:",s),new Error("Failed to save API key");await ue.trackKeyAdded(e,"google"),await ue.trackKeyVerification(e,"google",!0),R.success("✅ Custom API key saved! You now have unlimited queries.")}catch(r){const s=r instanceof Error?r.message:"Failed to save API key";throw R.error(s),r}}static async removeGeminiKey(e,t="user_action"){try{const{error:r}=await l.from("users").update({gemini_api_key_encrypted:null,uses_custom_gemini_key:!1,updated_at:new Date().toISOString()}).eq("auth_user_id",e.authUserId);if(r)throw console.error("[ApiKeyService] Error removing API key:",r),new Error("Failed to remove API key");await ue.trackKeyRemoved(e,"google",t),t==="user_action"&&R.success("Custom API key removed. Back to platform limits.")}catch(r){const s=r instanceof Error?r.message:"Failed to remove API key";throw R.error(s),r}}static async clearUserApiKeys(e){try{const{error:t}=await l.from("users").update({gemini_api_key_encrypted:null,uses_custom_gemini_key:!1,had_custom_key_before:l.raw("CASE WHEN uses_custom_gemini_key = true THEN true ELSE had_custom_key_before END"),updated_at:new Date().toISOString()}).eq("auth_user_id",e);if(t)throw console.error("[ApiKeyService] Error clearing API keys:",t),t;console.log("[ApiKeyService] ✅ Custom API keys cleared for user:",e)}catch(t){throw console.error("[ApiKeyService] Failed to clear API keys:",t),t}}static needsReVerification(e){if(!e)return!0;const t=new Date(e);return(Date.now()-t.getTime())/(1e3*60*60*24)>30}}class xr{constructor(){b(this,"submittedFeedback",new Set)}hasSubmittedFeedback(e){return this.submittedFeedback.has(e)}async submitFeedback(e){try{const t=ce.getCurrentUser();if(!(t!=null&&t.authUserId))return console.warn("[FeedbackService] User not authenticated"),{success:!1,error:"User not authenticated"};if(this.submittedFeedback.has(e.messageId))return console.log("[FeedbackService] Feedback already submitted for message:",e.messageId),{success:!0};const{error:r}=await l.from("ai_feedback").insert({user_id:t.authUserId,conversation_id:e.conversationId,message_id:e.messageId,feedback_type:e.feedbackType,content_type:e.contentType,category:e.category||null,comment:e.comment||null});return r?r.code==="23505"?(console.log("[FeedbackService] Feedback already exists in database"),this.submittedFeedback.add(e.messageId),{success:!0}):(console.error("[FeedbackService] Failed to submit feedback:",r),{success:!1,error:r.message}):(this.submittedFeedback.add(e.messageId),console.log("[FeedbackService] Feedback submitted:",{messageId:e.messageId,type:e.feedbackType,contentType:e.contentType}),{success:!0})}catch(t){return console.error("[FeedbackService] Error submitting feedback:",t),{success:!1,error:"Failed to submit feedback"}}}async submitPositiveFeedback(e,t,r="message"){return this.submitFeedback({messageId:e,conversationId:t,feedbackType:"up",contentType:r})}async submitNegativeFeedback(e,t,r,s,o="message"){return this.submitFeedback({messageId:e,conversationId:t,feedbackType:"down",contentType:o,category:r,comment:s})}async submitCorrection(e){try{const t=ce.getCurrentUser();if(!(t!=null&&t.authUserId))return console.warn("[FeedbackService] User not authenticated for correction"),{success:!1,error:"User not authenticated"};if(!B.getRateLimitStatus().allowed)return{success:!1,error:"Daily correction limit reached. Try again tomorrow.",rateLimitRemaining:0};const s={originalResponse:e.originalResponse,correctionText:e.correctionText,type:e.correctionType,scope:e.correctionScope,gameTitle:e.gameTitle,messageId:e.messageId,conversationId:e.conversationId},o=await B.submitCorrection(t.authUserId,s);return o.success?(console.log("[FeedbackService] Correction submitted successfully:",{messageId:e.messageId,type:e.correctionType,scope:e.correctionScope}),{success:!0,correction:o.correction,rateLimitRemaining:B.getRateLimitStatus().remaining}):{success:!1,error:o.error,rateLimitRemaining:B.getRateLimitStatus().remaining}}catch(t){return console.error("[FeedbackService] Error submitting correction:",t),{success:!1,error:"Failed to submit correction"}}}getCorrectionRateLimit(){return B.getRateLimitStatus()}async getUserCorrections(){const e=ce.getCurrentUser();return e!=null&&e.authUserId?B.getAllCorrections(e.authUserId):[]}async toggleCorrection(e,t){const r=ce.getCurrentUser();return r!=null&&r.authUserId?B.toggleCorrection(r.authUserId,e,t):!1}async getFeedbackStats(){try{const{data:e,error:t}=await l.from("ai_feedback").select("feedback_type, category");if(t)return console.error("[FeedbackService] Failed to get feedback stats:",t),null;const r={totalFeedback:e.length,positiveCount:e.filter(s=>s.feedback_type==="up").length,negativeCount:e.filter(s=>s.feedback_type==="down").length,categoryBreakdown:{}};return e.forEach(s=>{s.category&&(r.categoryBreakdown[s.category]=(r.categoryBreakdown[s.category]||0)+1)}),r}catch(e){return console.error("[FeedbackService] Error getting feedback stats:",e),null}}clearLocalTracking(){this.submittedFeedback.clear()}}const $r=new xr,vs=Object.freeze(Object.defineProperty({__proto__:null,feedbackService:$r},Symbol.toStringTag,{value:"Module"}));function Kr(a){var n;const e=a.split(","),t=((n=e[0].match(/:(.*?);/))==null?void 0:n[1])||"image/png",r=atob(e[1]),s=r.length,o=new Uint8Array(s);for(let i=0;i<s;i++)o[i]=r.charCodeAt(i);return new Blob([o],{type:t})}async function Wr(a,e){try{const t=Kr(a),r=t.size,s=50*1024*1024;if(r>s)return{success:!1,error:"Screenshot exceeds 50MB size limit"};const o=Date.now(),n=Math.random().toString(36).substring(2,15),i=`${o}_${n}.png`,c=`${e}/${i}`,{error:u}=await l.storage.from("screenshots").upload(c,t,{contentType:"image/png",cacheControl:"3600",upsert:!1});if(u)return console.error("Screenshot upload error:",u),{success:!1,error:u.message};const{data:f}=l.storage.from("screenshots").getPublicUrl(c);return f!=null&&f.publicUrl?{success:!0,publicUrl:f.publicUrl,fileSize:r}:{success:!1,error:"Failed to generate public URL"}}catch(t){return console.error("Screenshot upload exception:",t),{success:!1,error:t instanceof Error?t.message:"Unknown error"}}}const Cs=Object.freeze(Object.defineProperty({__proto__:null,uploadScreenshot:Wr},Symbol.toStringTag,{value:"Module"})),de=new Map;class Br{constructor(){b(this,"MAX_WORDS",300);b(this,"RECENT_MESSAGE_COUNT",8)}countWords(e){return e.trim().split(/\s+/).filter(t=>t.length>0).length}getTotalWordCount(e){return e.reduce((t,r)=>{const s=this.countWords(r.content);return t+s},0)}shouldSummarize(e){return!e.messages||e.messages.length<=this.RECENT_MESSAGE_COUNT?!1:this.getTotalWordCount(e.messages)>this.MAX_WORDS*3}splitMessages(e){if(e.length<=this.RECENT_MESSAGE_COUNT)return{toSummarize:[],toKeep:e};const t=e.length-this.RECENT_MESSAGE_COUNT;return{toSummarize:e.slice(0,t),toKeep:e.slice(t)}}async summarizeMessages(e,t,r){const s=this.getTotalWordCount(e),o=e.map(c=>`${c.role==="user"?"User":"Assistant"}: ${c.content}`).join(`
...
Provide ONLY the summary, no additional commentary.`;try{const c={id:"temp-summary",title:"Summary Request",messages:[{id:"summary-msg-"+Date.now(),role:"user",content:i,timestamp:Date.now()}],createdAt:Date.now(),updatedAt:Date.now(),isActive:!1,isGameHub:!1};console.log(`📡 [GEMINI CALL #2] 📋 Context Summarization | Messages: ${e.length} | Game: ${t||"N/A"} | Target: ${this.MAX_WORDS} words`);const u={id:"system",email:"system@otakon.ai",profileData:null},E=(await bt.getChatResponse(c,u,i,!1,!1,void 0,void 0,"summarization")).content.trim(),p=this.countWords(E);return console.log(`✅ [GEMINI CALL] Context Summarization SUCCESS | ${p} words (reduced from ${s})`),R.success(`Conversation summarized (${s} → ${p} words)`),de.delete("summarization"),{summary:E,wordCount:p,messagesIncluded:e.length,originalWordCount:s}}catch(c){console.error("❌ [ContextSummarization] Failed to generate summary:",c);const u=de.get("summarization")||0,f=3;if(u<f)return de.set("summarization",u+1),console.log(`🔄 [ContextSummarization] Retry ${u+1}/${f} in 1 second...`),await new Promise(p=>setTimeout(p,1e3)),this.summarizeMessages(e,t,r);console.error("❌ [ContextSummarization] Max retries reached"),de.delete("summarization");const E=e.slice(0,5).map(p=>p.content.substring(0,100)).join(" ... ").substring(0,this.MAX_WORDS*6);return{summary:`[Previous conversation context] ${E}`,wordCount:this.countWords(E),messagesIncluded:e.length,originalWordCount:s}}}async applyContextSummarization(e){if(!this.shouldSummarize(e))return e;const{toSummarize:t,toKeep:r}=this.splitMessages(e.messages);if(t.length===0)return e;const s=await this.summarizeMessages(t,e.gameTitle,e.genre),n=[{id:"summary-"+Date.now(),role:"system",content:s.summary,timestamp:t[t.length-1].timestamp,metadata:{isSummary:!0,messagesIncluded:s.messagesIncluded,originalWordCount:s.originalWordCount,summaryWordCount:s.wordCount}},...r],i=s.summary.replace(/!\[.*?\]\(data:image\/.*?\)/g,""),c=i.split(/\s+/).filter(f=>f.length>0),u=c.length>500?c.slice(0,500).join(" ")+"...":i;return console.log(`✅ [ContextSummarization] Context optimized: ${e.messages.length} messages → ${n.length} (${s.originalWordCount} words → ${s.wordCount} + recent)`),{...e,messages:n,contextSummary:u,lastSummarizedAt:Date.now(),updatedAt:Date.now()}}async getOptimizedContext(e){return this.shouldSummarize(e)?(await this.applyContextSummarization(e)).messages:e.messages}willTriggerSummarization(e){return this.getTotalWordCount(e.messages)>this.MAX_WORDS*3*.8}}const Hr=new Br,Is=Object.freeze(Object.defineProperty({__proto__:null,contextSummarizationService:Hr},Symbol.toStringTag,{value:"Module"}));export{Os as A,fs as B,Ss as C,es as D,le as E,Xr as F,Qr as G,vs as H,Cs as I,Is as J,Es as U,rs as W,ns as a,B as b,hs as c,U as d,ms as e,ds as f,gs as g,ps as h,Q as i,_s as j,ys as k,ws as l,cs as m,ls as n,is as o,os as p,us as q,bs as r,Zr as s,R as t,Ts as u,ss as v,as as w,As as x,ts as y,Nt as z};
