...
`)}
`)}return e.join(`
`)}async function os(s,e){try{const t=await k.getAIPreferences(s);if(t.responseHistoryScope==="off")return{previousTopics:[],corrections:[],scope:"off"};const[r,a]=await Promise.all([k.getResponseTopics(s,e,t.responseHistoryScope),k.getActiveCorrections(s,e,!0)]);return{previousTopics:r,corrections:a,scope:t.responseHistoryScope}}catch(t){return console.error("[PromptSystem] Error fetching behavior context:",t),null}}const xe=3e3,Ht=2e4,be=["story_so_far","quest_log","characters","boss_strategy","tips","hidden_secrets","points_of_interest"],Ke=`
...
**Tag Definitions:**
${fe}
`},ns=async(s,e,t,r,a,o,n,i,c)=>{const u=n?Bt(n):"",f=i?`
**User Timezone:** ${i}
