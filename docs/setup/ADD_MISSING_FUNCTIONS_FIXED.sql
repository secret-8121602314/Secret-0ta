-- ========================================
-- ADD MISSING FUNCTIONS AND TRIGGERS (FIXED)
-- This adds the missing pieces without conflicts
-- ========================================
...
-- ========================================
-- TRIGGERS FOR UPDATED_AT (CHECK IF EXISTS FIRST)
-- ========================================
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'ℹ️ user_profiles RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ user_preferences RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ games RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ conversations RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ chat_messages RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ diary_tasks RLS policy already exists';
    END IF;
    ...
    ELSE
        RAISE NOTICE 'ℹ️ diary_favorites RLS policy already exists';
    END IF;

    RAISE NOTICE '✅ All RLS policies processed successfully';
END $$;
