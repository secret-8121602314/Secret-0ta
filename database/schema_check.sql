...
CREATE POLICY "Users can delete subtabs of their conversations" ON "public"."subtabs" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."conversations"
  WHERE (("conversations"."id" = "subtabs"."conversation_id") AND ("conversations"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
CREATE POLICY "Users can insert subtabs to their conversations" ON "public"."subtabs" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."conversations"
  WHERE (("conversations"."id" = "subtabs"."conversation_id") AND ("conversations"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
CREATE POLICY "Users can update subtabs of their conversations" ON "public"."subtabs" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."conversations"
  WHERE (("conversations"."id" = "subtabs"."conversation_id") AND ("conversations"."user_id" = ( SELECT "auth"."uid"() AS "uid")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."conversations"
  WHERE (("conversations"."id" = "subtabs"."conversation_id") AND ("conversations"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
CREATE POLICY "Users can view subtabs of their conversations" ON "public"."subtabs" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."conversations"
  WHERE (("conversations"."id" = "subtabs"."conversation_id") AND ("conversations"."user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
