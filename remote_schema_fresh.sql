...
\restrict pZ3i0lghzxrQ4Xf8yWCyvk47gse9Bpd1wb7pgZzaiSXlhbRVtbbx17otgO7hW58
...
CREATE POLICY "Authenticated users can access own cache" ON "public"."app_cache" TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR ("user_id" IS NULL))) WITH CHECK ((("user_id" = "auth"."uid"()) OR ("user_id" IS NULL)));
...
\unrestrict pZ3i0lghzxrQ4Xf8yWCyvk47gse9Bpd1wb7pgZzaiSXlhbRVtbbx17otgO7hW58
