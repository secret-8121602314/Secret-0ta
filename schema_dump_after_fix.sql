...
CREATE POLICY "Users can delete subtabs from their conversations" ON "public"."subtabs" FOR DELETE USING (("conversation_id" IN ( SELECT "c"."id"
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
...
CREATE POLICY "Users can insert subtabs to their conversations" ON "public"."subtabs" FOR INSERT WITH CHECK (("conversation_id" IN ( SELECT "c"."id"
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE ("u"."auth_user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update subtabs in their conversations" ON "public"."subtabs" FOR UPDATE USING (("conversation_id" IN ( SELECT "c"."id"
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE ("u"."auth_user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view subtabs from their conversations" ON "public"."subtabs" FOR SELECT USING (("conversation_id" IN ( SELECT "c"."id"
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE ("u"."auth_user_id" = "auth"."uid"()))));
