                ...
                <section className="relative pt-20 pb-12 md:pb-16 text-center">
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        ...
                        <p className="text-xl md:text-2xl text-neutral-300 max-w-4xl mx-auto mb-16 leading-relaxed animate-fade-slide-up">
                            Otakon sees your screen and gives you the perfect nudge to keep you playing—without ruining the surprise. Stop searching, start playing.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            ...
                            <div className="text-center animate-fade-slide-up">
                                ...
                                <p className="text-lg text-neutral-300 leading-relaxed">
                                    Instantly send a screenshot from your PC to your phone. No alt-tabbing, no interruptions. Or use your mobile app to capture screenshots when using a controller.
                                </p>
                            </div>
                            ...
                            <div className="text-center animate-fade-slide-up">
                                ...
                                <p className="text-lg text-neutral-300 leading-relaxed">
                                    Our AI analyzes your exact situation and provides a perfect, spoiler-free hint. Plus, download high-quality screenshots directly to your mobile in seconds.
                                </p>
                            </div>
                            ...
                            <div className="text-center animate-fade-slide-up">
                                ...
                                <p className="text-lg text-neutral-300 leading-relaxed">
                                    Get the nudge you need and dive right back into the action. When you're not playing, explore lore, plan your next session with AI-suggested to-dos, and more.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <footer className="bg-transparent border-t border-neutral-800/50">
                <div className="container mx-auto px-6 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
                        <div>
                            <div className="flex items-center gap-0 mx-auto md:mx-0">
