...
\restrict f1RLc9Jkti7ta96ykTDyRir9u3FfdaYNPoqTBTEpVRDMi4a0Au97sap078NWVDU
...
CREATE INDEX "idx_app_cache_expires_at" ON "public"."app_cache" USING "btree" ("expires_at");
...
CREATE INDEX "idx_subtabs_game_id" ON "public"."subtabs" USING "btree" ("game_id");



CREATE INDEX "idx_subtabs_game_order" ON "public"."subtabs" USING "btree" ("game_id", "order_index");
...
CREATE POLICY "subtabs_delete_policy" ON "public"."subtabs" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE (("c"."id" = "subtabs"."conversation_id") AND ("u"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid"))))));



CREATE POLICY "subtabs_insert_policy" ON "public"."subtabs" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE (("c"."id" = "subtabs"."conversation_id") AND ("u"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
CREATE POLICY "subtabs_select_policy" ON "public"."subtabs" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE (("c"."id" = "subtabs"."conversation_id") AND ("u"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
CREATE POLICY "subtabs_update_policy" ON "public"."subtabs" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE (("c"."id" = "subtabs"."conversation_id") AND ("u"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."conversations" "c"
     JOIN "public"."users" "u" ON (("c"."user_id" = "u"."id")))
  WHERE (("c"."id" = "subtabs"."conversation_id") AND ("u"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid"))))));
...
\unrestrict f1RLc9Jkti7ta96ykTDyRir9u3FfdaYNPoqTBTEpVRDMi4a0Au97sap078NWVDU
