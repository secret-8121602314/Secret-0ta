-- Migration: Split grounding usage into two separate pools
-- Game Knowledge: 20 searches/month for new games (post Jan 2025)
-- AI Messages: 30 searches/month for chat queries
--
