...
const ActionButtons: React.FC<ActionButtonsProps> = React.memo(({
  ...
  return (
    <div className="flex items-center gap-1.5 sm:gap-2 mt-3 pt-3 border-t border-[#424242]/20">
      {/* Thumbs Up */}
      <button
        onClick={onThumbsUp}
        disabled={isLoading}
      ...
      <button
        ...
        disabled={isLoading}
        className="p-1.5 sm:p-2 rounded-lg transition-all duration-200 hover:scale-105 text-[#8A8A8A] hover:text-[#FFAB40] hover:bg-[#FFAB40]/10"
        title="Add to tasks"
      >
