/**
 * Quick Load Test - 10 seconds demo
 */

// Test scenarios
const TEST_SCENARIOS = {
  quick: { users: 5, duration: 10 }  // 5 users for 10 seconds
};
  ...
  async simulateUser(userId, duration) {
    ...
    try {
      ...
      while (Date.now() < endTime) {
        ...
        operationCount++;
        await this.delay(Math.random() * 200); // Random delay between operations
      }
      
      console.log(`✅ User ${userId} completed ${operationCount} operations`);
      this.results.successfulOperations += operationCount;
...
console.log('🧪 Otagon App Quick Load Test (10 seconds)');
console.log('==========================================');
console.log('This test simulates 5 users for 10 seconds to show you the results.\n');

tester.runTest('quick').catch(console.error);
