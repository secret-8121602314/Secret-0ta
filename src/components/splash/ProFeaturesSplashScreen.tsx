...
// Compact feature item for mobile
const CompactFeature: React.FC<{ title: string; isVanguard?: boolean }> = ({ title, isVanguard }) => (
  <div className="flex items-center gap-2 py-1.5">
    <svg className={`w-4 h-4 flex-shrink-0 ${isVanguard ? 'text-amber-400' : 'text-[#FFAB40]'}`} fill="currentColor" viewBox="0 0 20 20">
