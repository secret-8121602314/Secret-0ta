...
const proFeatures = [
  ...
  { title: "AI Mode Toggle", description: "Choose to analyze screenshots with AI or just store them for later. Save your query limits when you don't need instant insights.", icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#FFAB40]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h-1.5a5.5 5.5 0 0 0-5.5-5.5H13v1.77c.6.34 1 .99 1 1.73 0 1.1-.9 2-2 2s-2-.9-2-2c0-.74.4-1.39 1-1.73V8.5h-1A5.5 5.5 0 0 0 4.5 14H3a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2z" /><circle cx="12" cy="12" r="2" /><path d="M12 16v6" /><path d="M9 19l3 3 3-3" /></svg> },
  { title: "Hands-Free Voice Mode", description: "Stay focused on the action. Get hints read aloud to you without ever looking away from your screen.", icon: <HandsFreeIcon isActive={true} className="w-6 h-6 text-[#FFAB40]" /> },
