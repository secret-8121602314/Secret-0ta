  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center">
        {/* Icon */}
        <div className="mb-6">
          <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-[#E53A3A] to-[#D98C1F] flex items-center justify-center shadow-lg">
        ...
        {/* Decade Selector */}
        <div className="mb-6">
          <p className="text-sm text-[#CFCFCF] mb-3">Select a decade</p>
        ...
        {/* Year Selector */}
        <div className="mb-8">
          <p className="text-sm text-[#CFCFCF] mb-3">Select the year</p>
          <div className="flex flex-wrap justify-center gap-2">
            {yearsInDecade.map((year) => (
              <button
                key={year}
                onClick={() => setSelectedYear(year)}
                className={`w-16 py-2 rounded-lg text-sm font-medium transition-all ${
                  selectedYear === year
        ...
        <div className="mb-8 p-4 bg-[#1C1C1C] rounded-xl border border-[#424242]/40">
          <p className="text-[#8F8F8F] text-sm">Your gaming journey starts in</p>
          <p className="text-4xl font-bold bg-gradient-to-r from-[#E53A3A] to-[#D98C1F] bg-clip-text text-transparent">
            {selectedYear}
          </p>
        ...
        <button
          ...
          className="w-full py-3 px-6 bg-gradient-to-r from-[#E53A3A] to-[#D98C1F] text-white font-semibold rounded-xl hover:opacity-90 transition-opacity shadow-lg"
        >
          Start Exploring
        </button>
        ...
        <button
          ...
          className="mt-4 text-[#8F8F8F] text-sm hover:text-[#CFCFCF] transition-colors"
        >
          Skip for now
        </button>
      </div>
