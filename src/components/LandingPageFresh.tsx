    ...
    return (
        <div className="relative px-4 md:px-0">
            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex -ml-4" style={{ touchAction: 'pan-y pan-x' }}>
                    {isMobile ? (
                        ...
                        <div className="w-full max-w-2xl mx-auto mb-14 mt-10">
                            {hintDemoState === 'idle' ? (
                                ...
                                <button
                                    ...
                                    className="w-full group flex items-center justify-center gap-2 bg-transparent border-2 border-[#10B981]/60 text-[#10B981] font-medium py-4 px-6 rounded-xl transition-all duration-300 hover:border-[#10B981] hover:bg-[#10B981]/10 hover:text-[#10B981] hover:shadow-[0_0_20px_rgba(16,185,129,0.2)]"
                                >
