                        ...
                        <div className="w-full max-w-2xl mx-auto mb-14 mt-10">
                            {hintDemoState === 'idle' ? (
                                ...
                                <button
                                    ...
                                    className="w-full group flex items-center justify-center gap-2 bg-transparent border-2 border-[#E53A3A]/60 text-[#FF6B6B] font-medium py-4 px-6 rounded-xl transition-all duration-300 hover:border-[#E53A3A] hover:bg-[#E53A3A]/10 hover:text-white hover:shadow-[0_0_20px_rgba(229,58,58,0.2)]"
                                >
