...
export const insightTabsConfig: Record<string, Omit<SubTab, 'conversationId' | 'content' | 'isNew' | 'status'>[]> = {
  'Default': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention, hint at, or allude to any future events, characters, or plot twists. If context is limited, provide a general summary appropriate for the game's genre rather than inventing specifics." },
    ...
    { id: 'game_lore', title: 'Relevant Lore', type: 'story', instruction: "Provide a fascinating, detailed, spoiler-free piece of lore about the game's world, characters, or backstory that is relevant to the player's current situation or recent events. Base lore ONLY on what is explicitly known from context - do not invent lore, character backstories, or world details. Do not confuse different characters or their roles. If context is limited, provide general thematic lore appropriate for the genre." },
  ...
  'Action RPG': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for action RPGs rather than inventing specifics." },
  ...
  'RPG': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for RPGs rather than inventing specifics." },
    ...
    { id: 'lore_exploration', title: 'Lore Exploration', type: 'story', instruction: "Dive deep into the game's lore, world-building, and backstory relevant to the player's current progress without spoiling future revelations. Base lore ONLY on explicitly provided context - do not invent lore, character backstories, or world details. Do not confuse different characters or their roles. If context is limited, provide general thematic lore appropriate for the genre." },
  ...
  'Souls-like': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other (e.g., don't mix up NPCs, bosses, or companions). Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for Souls-like games rather than inventing specifics." },
  ...
  'Metroidvania': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for Metroidvania games rather than inventing specifics." },
  ...
  'Open-World': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for open-world games rather than inventing specifics." },
  ...
  'Survival-Crafting': [
    { id: 'story_so_far', title: 'Story So Far', type: 'story', instruction: "Provide a concise summary of the main plot events that have occurred strictly up to the estimated game progress. Base your summary ONLY on explicitly provided context - do not invent character names, relationships, or events. Do not confuse characters with each other. Do not mention future events or plot twists. If context is limited, provide a general summary appropriate for survival-crafting games rather than inventing specifics." },
