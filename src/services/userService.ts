  ...
  static async getCurrentUserAsync(): Promise<User | null> {
    try {
      ...
      const user: User = {
        ...
        // Onboarding flags
        hasProfileSetup: (dbUser as Record<string, unknown>).has_profile_setup as boolean || false,
        hasSeenSplashScreens: (dbUser as Record<string, unknown>).has_seen_splash_screens as boolean || false,
        hasSeenHowToUse: (dbUser as Record<string, unknown>).has_seen_how_to_use as boolean || false,
        hasSeenFeaturesConnected: (dbUser as Record<string, unknown>).has_seen_features_connected as boolean || false,
        hasSeenProFeatures: (dbUser as Record<string, unknown>).has_seen_pro_features as boolean || false,
        hasSeenWelcomeGuide: (dbUser as Record<string, unknown>).has_seen_welcome_guide as boolean || false,
        pcConnected: (dbUser as Record<string, unknown>).pc_connected as boolean || false,
        pcConnectionSkipped: (dbUser as Record<string, unknown>).pc_connection_skipped as boolean || false,
        onboardingCompleted: (dbUser as Record<string, unknown>).onboarding_completed as boolean || false,
        hasWelcomeMessage: (dbUser as Record<string, unknown>).has_welcome_message as boolean || false,
        isNewUser: (dbUser as Record<string, unknown>).is_new_user as boolean || false,
        hasUsedTrial: (dbUser as Record<string, unknown>).has_used_trial as boolean || false,
    ...
    try {
      ...
      const { data, error, count } = await supabase
        ...
        .update({
          ...
          has_seen_welcome_guide: user.hasSeenWelcomeGuide,
