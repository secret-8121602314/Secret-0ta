                ...
                <section className="relative pt-20 pb-6 md:pb-8 text-center">
                    ...
                    <div className="container mx-auto px-6 relative overflow-visible">
                        <div className="flex flex-col items-center justify-center gap-4 mb-10 overflow-visible">
                            <Logo className="h-32 w-32 animate-bounce-slow" />
                            <h1 
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
                            <div className="flex items-center gap-2 text-lg text-neutral-300">
                                <div className="flex -space-x-2">
                                    {[...Array(5)].map((_, i) => (
                                        <div key={i} className="w-8 h-8 rounded-full border-2 border-transparent bg-gradient-to-r from-[#E53A3A] to-[#D98C1F] p-0.5 overflow-hidden">
                                            <div className="w-full h-full rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center">
                                                <div className="w-6 h-6 bg-gradient-to-br from-[#E53A3A] to-[#D98C1F] rounded-full flex items-center justify-center text-white text-xs font-bold">
                                ...
                                <span className="ml-2">
                                    <span className="font-bold text-white">100+</span> gamers waiting
                                </span>
                            </div>
                            <div className="hidden sm:block w-px h-6 bg-neutral-600"></div>
                            <div className="flex items-center gap-2 text-lg text-neutral-300">
                                <StarIcon className="w-5 h-5 text-[#FFAB40]" />
