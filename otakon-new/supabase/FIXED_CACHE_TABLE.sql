-- Fixed Enhanced Cache Table for Chat Persistence and AI Memory
-- This fixes all Supabase linter warnings
...
-- ✅ FIXED: Single consolidated policy for all operations (fixes multiple permissive policies)
...
-- ✅ FIXED: Create a function to automatically update the updated_at timestamp with security
...
-- ✅ FIXED: Create a function to clean up expired cache entries with security
...
-- ✅ FIXED: Create a function to get cache statistics with security
...
-- ✅ FIXED: Create a function to get user-specific cache entries with security
...
-- ✅ FIXED: Create a function to clear user cache with security
...
-- ✅ FIXED: Create a function to get cache performance metrics with security
...
-- Create a view for monitoring cache health (SECURITY INVOKER for proper RLS)
