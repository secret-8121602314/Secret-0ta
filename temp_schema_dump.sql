...
COMMENT ON FUNCTION "public"."get_complete_user_data"("p_auth_user_id" "uuid") IS 'Returns complete user data including BYOK (Bring Your Own Key) columns. Updated 2025-12-27 for custom API key support.';
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "uses_custom_gemini_key" boolean DEFAULT false,
    "gemini_api_key_encrypted" "text",
    "custom_key_verified_at" timestamp with time zone,
    "had_custom_key_before" boolean DEFAULT false,
...
CREATE INDEX "idx_users_custom_gemini_key" ON "public"."users" USING "btree" ("uses_custom_gemini_key") WHERE ("uses_custom_gemini_key" = true);
